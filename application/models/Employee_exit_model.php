...
class employee_exit_model extends CI_Model {
	...
	{
	  return $this->db->get("employee_exit");
	}
	...
	public function all_exit_types() {
	  $query = $this->db->query("SELECT * from employee_exit_type");
  	  return $query->result();
	}
	...
	public function add($data){
		$this->db->insert('employee_exit', $data);
	...
	public function update_record($data, $id){
		$this->db->where('exit_id', $id);
		if( $this->db->update('employee_exit',$data)) {
			return true;
		} else {
			return false;
		}		
