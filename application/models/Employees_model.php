...
class employees_model extends CI_Model {
	...
	public function get_total_employees() {
	 ...
	 // get total number of present employees by date today
	 public function get_present_employees() {
			$today_date = date('Y-m-d'); // capture current date
			$query = $this->db->query("SELECT * from attendance_time WHERE attendance_status ='present'and `attendance_date` = '".$today_date."' order by time_attendance_id desc");
			
  	  return $query->num_rows();
	 }


	 //get total holidays by month
	 public function get_present_holidays() {
		 $current_month = date('Y-m-d');
		 $query = $this->db->query("SELECT * from holidays WHERE is_publish = '1' and `start_date` = '".$current_month."' order by holiday_id desc");

		 return $query->num_rows();
	 }

	 // get total number of employees
	//  public function get_absent_employees() {
	// 	$query = $this->db->query("SELECT * from attendance_time WHERE attendance_status ='absent'");
	// 	  return $query->num_rows();
	//   }
	  // get total number of employees
	//  public function get_leave_employees() {
	// 	$query = $this->db->query("SELECT * from attendance_time WHERE attendance_status ='leave'");
	// 	  return $query->num_rows();
	//   }
	...
	// Function to update record in table > work_benefits
	public function work_benefits($data, $id){
		$this->db->where('user_id', $id);
	...
	public function contact_info_update($data, $id){
		...
		if( $this->db->update('employee_contacts',$data)) {
			return true;
		} else {
			return false;
		}		
	...
	public function img_document_info_update($data, $id){
		...
		if( $this->db->update('employee_immigration',$data)) {
			return true;
		} else {
			return false;
		}		
	...
	public function immigration_info_add($data){
		$this->db->insert('employee_immigration', $data);
		if ($this->db->affected_rows() > 0) {
			return true;
		} else {
			return false;
	...
	public function qualification_info_add($data){
		$this->db->insert('employee_qualification', $data);
		if ($this->db->affected_rows() > 0) {
			return true;
		} else {
			return false;
	...
	public function bank_account_info_add($data){
		$this->db->insert('employee_bankaccount', $data);
		if ($this->db->affected_rows() > 0) {
			return true;
		} else {
			return false;
	...
	public function bank_account_info_update($data, $id){
		...
		if( $this->db->update('employee_bankaccount',$data)) {
			return true;
		} else {
			return false;
		}		
	...
	// get current contacts by id
	 public function read_contact_info_current($id) {
		...
		$query = $this->db->get('employee_contacts');
		$row = $query->row();
		return $row;
	...
	public function shift_info_update($data, $id){
		...
		if( $this->db->update('employee_shift',$data)) {
			return true;
		} else {
			return false;
		}		
	...
	public function location_info_update($data, $id){
		...
		if( $this->db->update('employee_location',$data)) {
			return true;
		} else {
			return false;
		}		
	...
	public function all_office_shifts() {
	  $query = $this->db->query("SELECT * from office_shift");
  	  return $query->result();
	}
	...
	public function set_employee_qualification($id) {
		...
		$condition = "employee_id =" . "'" . $id . "'";
		$this->db->select('*');
		$this->db->from('employee_qualification');
		$this->db->where($condition);
		$this->db->limit(500);
	  return $this->db->get();
	}
	...
	public function set_employee_experience($id) {
		...
		$condition = "employee_id =" . "'" . $id . "'";
		$this->db->select('*');
		$this->db->from('employee_work_experience');
		$this->db->where($condition);
		$this->db->limit(500);
	  return $this->db->get();
	}
	...
	public function set_employee_bank_account($id) {
		...
		$condition = "employee_id =" . "'" . $id . "'";
		$this->db->select('*');
		$this->db->from('employee_bankaccount');
		$this->db->where($condition);
		$this->db->limit(500);
	  return $this->db->get();
	}
	...
	public function set_employee_location($id) {
		...
		$condition = "employee_id =" . "'" . $id . "'";
		$this->db->select('*');
		$this->db->from('employee_location');
		$this->db->where($condition);
		$this->db->limit(500);
	  return $this->db->get();
	}
	...
	// get contacts by id
	public function read_employee_benefits($id) {
	...
	public function all_contract_types() {
	  $query = $this->db->query("SELECT * from contract_type");
  	  return $query->result();
	}
	
	// get all contracts
	public function all_contracts() {
	  $query = $this->db->query("SELECT * from employee_contract");
  	  return $query->result();
	}
	
	// get all document types
	public function all_document_types() {
	  $query = $this->db->query("SELECT * from document_type");
  	  return $query->result();
	}
	
	// get all education level
	public function all_education_level() {
	  $query = $this->db->query("SELECT * from qualification_education_level");
  	  return $query->result();
	}
	...
	public function all_qualification_language() {
	  $query = $this->db->query("SELECT * from qualification_language");
  	  return $query->result();
	}
	...
	public function all_qualification_skill() {
	  $query = $this->db->query("SELECT * from qualification_skill");
  	  return $query->result();
	} 
	...
	public function delete_contact_record($id){
		$this->db->where('contact_id', $id);
		$this->db->delete('employee_contacts');
	...
	public function delete_imgdocument_record($id){
		$this->db->where('immigration_id', $id);
		$this->db->delete('employee_immigration');
	...
	public function delete_qualification_record($id){
		$this->db->where('qualification_id', $id);
		$this->db->delete('employee_qualification');
	...
	public function delete_bank_account_record($id){
		$this->db->where('bankaccount_id', $id);
		$this->db->delete('employee_bankaccount');
	...
	public function delete_contract_record($id){
		$this->db->where('contract_id', $id);
		$this->db->delete('employee_contract');
	...
	public function delete_location_record($id){
		$this->db->where('office_location_id', $id);
		$this->db->delete('employee_location');
