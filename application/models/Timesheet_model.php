<?php
	...
	public function get_office_shifts() {
	  return $this->db->get("office_shift");
	}
	...
	public function total_hours_worked_attendance($id,$attendance_date) {
		return $query = $this->db->query("SELECT * from attendance_time where employee_id='".$id."' and attendance_date='".$attendance_date."' and total_work!=''");
	}
	
	// get total rest > attendance
	public function total_rest_attendance($id,$attendance_date) {
		return $query = $this->db->query("SELECT * from attendance_time where employee_id='".$id."' and attendance_date='".$attendance_date."' and total_rest!=''");
	}
	...
	public function get_leaves() {
	  return $this->db->get("leave_applications");
	}
	
	// get all employee leaves
	public function get_employee_leaves($id) {
	 return $query = $this->db->query("SELECT * from leave_applications where employee_id='".$id."'");
	}
	...
	public function count_total_leaves($leave_type_id,$employee_id) {
		$query = $this->db->query("SELECT * from leave_applications where employee_id = '".$employee_id."' and leave_type_id='".$leave_type_id."'");
	...
	public function attendance_employee_with_date($emp_id,$attendance_date) {
		return $query = $this->db->query("SELECT * from attendance_time where attendance_date = '".$attendance_date."' and employee_id = '".$emp_id."'");
	}
	...
	public function delete_attendance_record($id){ 
		...
		$this->db->delete('attendance_time');
	...
	public function delete_leave_record($id){ 
		...
		$this->db->delete('leave_applications');
	...
	public function update_leave_record($data, $id){
		$this->db->where('leave_id', $id);
		if( $this->db->update('leave_applications',$data)) {
			return true;
		} else {
			return false;
		}		
	...
	public function update_attendance_record($data, $id){
		$this->db->where('time_attendance_id', $id);
		if( $this->db->update('attendance_time',$data)) {
			return true;
		} else {
			return false;
		}		
	...
	public function update_shift_record($data, $id){
		$this->db->where('office_shift_id', $id);
		if( $this->db->update('office_shift',$data)) {
			return true;
		} else {
			return false;
		}		
	...
	public function get_comments($id) {
		return $query = $this->db->query("SELECT * from tasks_comments where task_id = '".$id."'");
	}
	
	// get comments
	public function get_attachments($id) {
		return $query = $this->db->query("SELECT * from tasks_attachment where task_id = '".$id."'");
	}
	
	// Function to add record in table > add comment
	public function add_comment($data){
		$this->db->insert('tasks_comments', $data);
		if ($this->db->affected_rows() > 0) {
			return true;
		} else {
			return false;
	...
	public function check_user_attendance() {
		...
		return $query = $this->db->query("SELECT * FROM attendance_time where `employee_id` = '".$session['user_id']."' and `attendance_date` = '".$today_date."' order by time_attendance_id desc");
		//time_attendance_id desc limit 1");
	}
	...
	public function check_user_attendance_clockout() {
		$today_date = date('Y-m-d');
		$session = $this->session->userdata('username');
		return $query = $this->db->query("SELECT * FROM attendance_time where `employee_id` = '".$session['user_id']."' and `attendance_date` = '".$today_date."' and clock_out order by time_attendance_id desc");
		//clock_out='' order by time_attendance_id desc limit 1");
	}
	...
	public function get_last_user_attendance() {
		...
		$session = $this->session->userdata('username');
		$query = $this->db->query("SELECT * FROM attendance_time where `employee_id` = '".$session['user_id']."' order by time_attendance_id desc limit 1");
		return $query->result();
	}
