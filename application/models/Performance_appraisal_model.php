...
class performance_appraisal_model extends CI_Model {
	...
	public function get_performance_appraisal() {
	  return $this->db->get("performance_appraisal");
	}
	
	public function get_employee_performance_appraisal($id) {
	 	return $query = $this->db->query("SELECT * from performance_appraisal where employee_id = '".$id."'");
	}
	...
	public function delete_record($id){
		...
		$this->db->delete('performance_appraisal');
	...
	public function update_record($data, $id){
		$this->db->where('performance_appraisal_id', $id);
		if( $this->db->update('performance_appraisal',$data)) {
			return true;
		} else {
			return false;
		}		
