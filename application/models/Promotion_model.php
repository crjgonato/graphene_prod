...
class promotion_model extends CI_Model {
	...
	public function get_promotions() {
	  return $this->db->get("employee_promotions");
	}
	
	public function get_employee_promotions($id) {
	 	return $query = $this->db->query("SELECT * from employee_promotions where employee_id = '".$id."'");
	}
	...
	public function update_record($data, $id){
		$this->db->where('promotion_id', $id);
		if( $this->db->update('employee_promotions',$data)) {
			return true;
		} else {
			return false;
		}		
