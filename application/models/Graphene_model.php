...
class graphene_model extends CI_Model {
	...
	public function attendance_time_checks($id) {
		...
		return $query = $this->db->query("SELECT * FROM attendance_time where `employee_id` = '".$id."' and clock_out = '' order by time_attendance_id desc limit 1");
	}
	...
	public function get_employee_officeshift($id) {
	 	return $query = $this->db->query("SELECT * from employee_shift where employee_id = '".$id."'");
	}
	...
	{
	  $query = $this->db->query("SELECT * from leave_applications");
  	  return $query->result();
	}
	...
	{
	  $query = $this->db->query("SELECT * from leave_applications order by leave_id desc limit 5");
  	  return $query->result();
	}
	...
	{
	  $query = $this->db->query("SELECT * from office_location");
  	  return $query->result();
	}
	...
	public function all_policies() {
	 	$query = $this->db->query("SELECT * from company_policy");
		return $query->result();
	}
	...
	public function update_company_info_record($data, $id){
		...
		if( $this->db->update('company_info',$data)) {
			return true;
		} else {
			return false;
		}		
	...
	public function add_backup($data){
		$this->db->insert('database_backup', $data);
	...
	public function all_db_backup() {
	 	return  $query = $this->db->query("SELECT * from database_backup");
	}
	
	// Function to Delete selected record from table
	public function delete_single_backup_record($id){
		$this->db->where('backup_id', $id);
		$this->db->delete('database_backup');
		
	}
	// Function to Delete selected record from table
	public function delete_all_backup_record(){
		$this->db->empty_table('database_backup');
		
	}
	
	// get all email templates 
	public function get_email_templates() {
	 	return  $query = $this->db->query("SELECT * from email_template");
	}
	...
	public function get_contract_types() {
	 	return  $query = $this->db->query("SELECT * from contract_type");
	}
	
	// get all table rows 
	public function get_qualification_education() {
	 	return  $query = $this->db->query("SELECT * from qualification_education_level");
	}
	
	// get all table rows 
	public function get_qualification_language() {
	 	return  $query = $this->db->query("SELECT * from qualification_language");
	}
	
	// get all table rows 
	public function get_qualification_skill() {
	 	return  $query = $this->db->query("SELECT * from qualification_skill");
	}
	
	// get all table rows 
	public function get_document_type() {
	 	return  $query = $this->db->query("SELECT * from document_type");
	}
	
	// get all table rows 
	public function get_award_type() {
	 	return  $query = $this->db->query("SELECT * from award_type");
	}
	
	// get all table rows 
	public function get_leave_type() {
	 	return  $query = $this->db->query("SELECT * from leave_type");
	}
	
	// get all table rows 
	public function get_warning_type() {
	 	return  $query = $this->db->query("SELECT * from warning_type");
	}
	
	// get all table rows 
	public function get_termination_type() {
	 	return  $query = $this->db->query("SELECT * from termination_type");
	}
	
	// get all table rows 
	public function get_expense_type() {
	 	return  $query = $this->db->query("SELECT * from expense_type");
	}
	
	// get all table rows 
	public function get_job_type() {
	 	return  $query = $this->db->query("SELECT * from job_type");
	}
	
	// get all table rows 
	public function get_exit_type() {
	 	return  $query = $this->db->query("SELECT * from employee_exit_type");
	}
	
	// get all table rows 
	public function get_travel_type() {
	 	return  $query = $this->db->query("SELECT * from travel_arrangement_type");
	}
	
	// get all table rows 
	public function get_payment_method() {
	 	return  $query = $this->db->query("SELECT * from payment_method");
	}
	...
	public function add_edu_level($data){
		$this->db->insert('qualification_education_level', $data);
		if ($this->db->affected_rows() > 0) {
			return true;
		} else {
			return false;
	...
	public function add_edu_language($data){
		$this->db->insert('qualification_language', $data);
		if ($this->db->affected_rows() > 0) {
			return true;
		} else {
			return false;
	...
	public function add_edu_skill($data){
		$this->db->insert('qualification_skill', $data);
		if ($this->db->affected_rows() > 0) {
			return true;
		} else {
			return false;
	...
	public function add_award_type($data){
		$this->db->insert('award_type', $data);
		if ($this->db->affected_rows() > 0) {
			return true;
		} else {
			return false;
	...
	public function add_warning_type($data){
		$this->db->insert('warning_type', $data);
		if ($this->db->affected_rows() > 0) {
			return true;
		} else {
			return false;
	...
	public function add_exit_type($data){
		$this->db->insert('employee_exit_type', $data);
		if ($this->db->affected_rows() > 0) {
			return true;
		} else {
			return false;
	...
	public function last_eight_employees()
	{
	  $query = $this->db->query("SELECT * from employees order by user_id desc limit 7");
  	  return $query->result();
	}
	...
	{
	  $query = $this->db->query("SELECT * FROM job_applications order by application_id desc limit 4");
  	  return $query->result();
	}
	...
	{
	  $query = $this->db->query("SELECT m.*, c.* FROM make_payment as m, companies as c where m.company_id = c.company_id group by m.company_id");
  	  return $query->result();
	}
	...
	public function get_company_make_payment($id) {
		...
		$query = $this->db->query("SELECT SUM(payment_amount) as paidAmount FROM make_payment where company_id='".$id."'");
	...
	{
	  $query = $this->db->query("SELECT m.*, l.* FROM make_payment as m, office_location as l where m.location_id = l.location_id group by m.location_id");
  	  return $query->result();
	}
	...
	public function get_location_make_payment($id) {
		...
		$query = $this->db->query("SELECT SUM(payment_amount) as paidAmount FROM make_payment where location_id='".$id."'");
		return $query->result();
	}
	...
	{
	  $query = $this->db->query("SELECT m.*, d.* FROM make_payment as m, departments as d where m.department_id = d.department_id group by m.department_id");
  	  return $query->result();
	}
	...
	public function get_department_make_payment($id) {
		...
		$query = $this->db->query("SELECT SUM(payment_amount) as paidAmount FROM make_payment where department_id='".$id."'");
		return $query->result();
	}
	...
	{
	  $query = $this->db->query("SELECT m.*, d.* FROM make_payment as m, designations as d where m.designation_id = d.designation_id group by m.designation_id");
  	  return $query->result();
	}
	...
	public function get_designation_make_payment($id) {
		...
		$query = $this->db->query("SELECT SUM(payment_amount) as paidAmount FROM make_payment where designation_id='".$id."'");
		return $query->result();
	}
	...
	public function read_education_level($id) {
		...
		$this->db->select('*');
		$this->db->from('qualification_education_level');
		$this->db->where($condition);
		$this->db->limit(1);
		$query = $this->db->get();
	...
	public function read_qualification_language($id) {
		...
		$this->db->select('*');
		$this->db->from('qualification_language');
		$this->db->where($condition);
		$this->db->limit(1);
		$query = $this->db->get();
	...
	public function read_qualification_skill($id) {
		...
		$this->db->select('*');
		$this->db->from('qualification_skill');
		$this->db->where($condition);
		$this->db->limit(1);
		$query = $this->db->get();
	...
	public function read_exit_type($id) {
		...
		$this->db->select('*');
		$this->db->from('employee_exit_type');
		$this->db->where($condition);
		$this->db->limit(1);
		$query = $this->db->get();
	...
	public function read_travel_arr_type($id) {
		...
		$this->db->select('*');
		$this->db->from('travel_arrangement_type');
		$this->db->where($condition);
		$this->db->limit(1);
		$query = $this->db->get();
	...
	public function update_contract_type_record($data, $id){
		$this->db->where('contract_type_id', $id);
		if( $this->db->update('contract_type',$data)) {
			return true;
		} else {
			return false;
		}		
	...
	public function update_education_level_record($data, $id){
		$this->db->where('education_level_id', $id);
		if( $this->db->update('qualification_education_level',$data)) {
			return true;
		} else {
			return false;
		}		
	...
	public function update_qualification_language_record($data, $id){
		$this->db->where('language_id', $id);
		if( $this->db->update('qualification_language',$data)) {
			return true;
		} else {
			return false;
		}		
	...
	public function update_qualification_skill_record($data, $id){
		$this->db->where('skill_id', $id);
		if( $this->db->update('qualification_skill',$data)) {
			return true;
		} else {
			return false;
		}		
	...
	public function update_award_type_record($data, $id){
		$this->db->where('award_type_id', $id);
		if( $this->db->update('award_type',$data)) {
			return true;
		} else {
			return false;
		}		
	...
	public function update_warning_type_record($data, $id){
		$this->db->where('warning_type_id', $id);
		if( $this->db->update('warning_type',$data)) {
			return true;
		} else {
			return false;
		}		
	...
	public function update_termination_type_record($data, $id){
		$this->db->where('termination_type_id', $id);
		if( $this->db->update('termination_type',$data)) {
			return true;
		} else {
			return false;
		}		
	...
	public function update_expense_type_record($data, $id){
		$this->db->where('expense_type_id', $id);
		if( $this->db->update('expense_type',$data)) {
			return true;
		} else {
			return false;
		}		
	...
	public function single_email_template($id){
		...
		$query = $this->db->query("SELECT * from email_template where template_id = '".$id."'");
		return $query->result();
	}
	...
	public function update_job_type_record($data, $id){
		$this->db->where('job_type_id', $id);
		if( $this->db->update('job_type',$data)) {
			return true;
		} else {
			return false;
		}		
	...
	public function update_exit_type_record($data, $id){
		$this->db->where('exit_type_id', $id);
		if( $this->db->update('employee_exit_type',$data)) {
			return true;
		} else {
			return false;
		}		
	...
	public function update_travel_arr_record($data, $id){
		$this->db->where('arrangement_type_id', $id);
		if( $this->db->update('travel_arrangement_type',$data)) {
			return true;
		} else {
			return false;
		}		
	...
	public function current_month_attendance() {
		...
		$session = $this->session->userdata('username');
		$query = $this->db->query("SELECT * from attendance_time where attendance_date like '%".$current_month."%' and `employee_id` = '".$session['user_id']."'  group by attendance_date");
		return $query->num_rows();
	}
	...
	public function all_open_tickets() {
		$query = $this->db->query("SELECT * FROM support_tickets WHERE ticket_status ='1'");
		 return $query->num_rows();
	}
	
	// get all closed tickets
	public function all_closed_tickets() {
		$query = $this->db->query("SELECT * FROM support_tickets WHERE ticket_status ='2'");
		 return $query->num_rows();
	}
