    ...
    <div class="row">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="form-group">
              ...
              <input class="form-control d_date" placeholder="_" readonly name="notice_date" type="text" value="<?php echo $notice_date;?>">
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-md-12">
            <div class="form-group">
             ...
             <input class="form-control d_date" placeholder="_" readonly name="resignation_date" type="text" value="<?php echo $resignation_date;?>">
            </div>
          </div>
        </div>
      </div>
      <div class="col-md-6">
        <div class="form-group">
          ...
          <textarea class="form-control textarea" placeholder="_" name="reason" cols="30" rows="10" id="reason2"><?php echo $reason;?></textarea>
        </div>
      </div>
    </div>
  </div>
