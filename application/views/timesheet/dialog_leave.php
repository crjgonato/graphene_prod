    ...
    <div class="row">
      <div class="col-md-6">
        <div class="form-group">
          ...
          <select class="form-control" name="leave_type" data-plugin="select_hrm" data-placeholder="_">
            <option value=""></option>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input class="form-control e_date" placeholder="_" readonly="true" name="start_date" type="text" value="<?php echo $from_date;?>">
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
              <label for="end_date">End Date</label>
              <input class="form-control e_date" placeholder="_" readonly="true" name="end_date" type="text" value="<?php echo $to_date;?>">
            </div>
          </div>
        </div>
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <select name="withpay" id="" class="form-control" data-plugin="select_hrm">
                <option value="1" <?php if($withpay=='1'):?> selected <?php endif; ?>>Yes</option>
                <option value="2" <?php if($withpay=='2'):?> selected <?php endif; ?>>No</option>
              </select>
            </div>
          </div>
        </div>
      ...
      <div class="col-md-6">
        <div class="form-group">
          ...
          <textarea class="form-control textarea" placeholder="_" name="remarks" cols="30" rows="15" id="remarks2"><?php echo $remarks;?></textarea>
        </div>
      </div>
    </div>
    <div class="form-group">
      <label for="reason">Reason</label>
      <textarea class="form-control" placeholder="_" name="reason" cols="30" rows="3" id="reason"><?php echo $reason;?></textarea>
    </div>
  </div>
