      ...
      <form class="m-b-1" action="<?php echo site_url("timesheet/add_holiday") ?>" method="post" name="add_holiday" id="xin-form">
        <div class="row">
            <div class="col-md-12">
              ...
              <input type="text" class="form-control" name="event_name" placeholder="_">
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input class="form-control date" placeholder="_" readonly name="start_date" type="text">
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
              <label for="end_date">End Date <font color="red">*</font></label>
              <input class="form-control date" placeholder="_" readonly name="end_date" type="text">
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-md-12">
            <div class="form-group">
              ...
              <textarea class="form-control textarea" placeholder="_" name="description" cols="30" rows="15" id="description"></textarea>
            </div>
          </div>
        </div>
        <div class="row">
