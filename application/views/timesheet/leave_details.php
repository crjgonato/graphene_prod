      ...
      <table class="table table-condensed table-hover m-md-b-0">
        <tbody>
          ...
          <tr>
            ...
            <td class="text-right"><?php echo $this->Graphene_model->set_date_format($from_date);?></td>
          </tr>
          <tr>
            <th scope="row">To Date</th>
            <td class="text-right"><?php echo $this->Graphene_model->set_date_format($to_date);?></td>
          </tr>
        </tbody>
      </table>
      <br>
