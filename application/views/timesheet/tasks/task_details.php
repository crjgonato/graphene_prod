    ...
    <div class="box box-block bg-white">
      <div class="wizard" role="tabpanel">
        ...
        <div class="tab-content m-b-1">
          ...
          <div role="tabpanel" class="tab-pane animated fadeInUp fade" id="comment">
            <form action="<?php echo site_url("timesheet/set_comment") ?>" method="post" name="set_comment" id="set_comment">
              ...
              <div class="box-block">
                <div class="form-group">
                  <textarea name="graphene_comment" id="graphene_comment" class="form-control" rows="4" placeholder="Comment"></textarea>
                </div>
                <button type="submit" class="btn btn-primary save">Save</button>
              </div>
            </form>
            ...
            <div class="table-responsive">
              <table class="table table-hover mb-md-0" id="graphene_comment_table" style="width:100%;">
                <thead>
                  <tr>
                    <th>All Comments</th>
                  </tr>
          ...
          <div role="tabpanel" class="tab-pane animated fadeInUp fade" id="attachment">
            ...
            <div class="table-responsive">
              <table class="table table-hover table-condensed table-hover table-bordered table-ajax-load" id="graphene_attachment_table" style="width:100%;">
                <thead>
                  <tr>
                    <th>Option</th>
                    <th>Title</th>
          ...
          <div role="tabpanel" class="tab-pane animated fadeInUp fade" id="notebook">
