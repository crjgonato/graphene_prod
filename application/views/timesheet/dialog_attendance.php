...
if(isset($_GET['jd']) && isset($_GET['employee_id']) && $_GET['data']=='add_attendance'){
	// get addd by > template
		$user = $this->Graphene_model->read_user_info($_GET['employee_id']);
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="form-group">
              ...
              <input class="form-control attendance_date_m" placeholder="_" readonly="true" id="attendance_date_m" name="attendance_date_m" type="text">
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input class="form-control timepicker_m" placeholder="_" readonly="true" id="clock_in_m" name="clock_in_m" type="text">
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
              <label for="clock_out">Office Out Time</label>
              <input class="form-control timepicker_m" placeholder="_" readonly="true" id="clock_out_m" name="clock_out_m" type="text">
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="form-group">
              ...
              <input class="form-control timepicker" placeholder="Office Out Time" readonly="true" name="clock_out" type="text" value="<?php echo $clock_out;?>">
				...
				<!-- <div class="row">
					<div class="col-md-6">
							<div class="form-group">
								<label for="remarks">Remarks (if any changes)</label>
								<input class="form-control timepicker" placeholder="Office Out Time" readonly="true" name="clock_out" type="text" value="<//?php echo $clock_out;?>">
								<textarea class="form-control"  placeholder="_" name="remarks" cols="30" rows="3"><?php echo $remarks;?></textarea>
							</div>
						</div>
				</div> -->
      </div>
