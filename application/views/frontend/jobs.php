    ...
    <div class="header-nav-bar">
      <div class="container"> 
        ...
        <div class="css-table logo">
          <div class="css-table-cell"> <a href="<?php echo site_url();?>frontend/jobs/"> <img src="<?php echo base_url();?>uploads/logo/job/<?php echo $system[0]->job_logo;?>" alt="Careers"> </a> <!-- end .logo --> 
          </div>
        </div>
