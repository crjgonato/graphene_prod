...
<link rel="stylesheet" href="<?php echo base_url();?>skin/vendor/jobs/css/fontawesome.min.css">
...
<div id="main-wrapper">
    ...
    <div class="header-nav-bar">
      <div class="container"> 
        ...
        <div class="css-table logo">
          <div class="css-table-cell"> <a href="<?php echo site_url();?>frontend/jobs/"><img src="<?php echo base_url();?>uploads/logo/job/<?php echo $system[0]->job_logo;?>" alt="Careers"></a> 
            <!-- end .logo --> 
          </div>
        </div>
  ...
  <!-- end #page-content -->
  <div class="modal fade apply-job" id="apply-job" tabindex="-1" role="dialog" aria-labelledby="apply-job" aria-hidden="true" data-backdrop="static" data-keyboard="false">
