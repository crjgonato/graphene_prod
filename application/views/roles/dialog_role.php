        ...
        <div class="row">
          <div class="col-md-12">
            <div class="form-group">
              ...
              <input class="form-control" placeholder="_" name="role_name" type="text" value="<?php echo $role_name;?>">
            </div>
          </div>
        </div>
        <div class="row">
          ...
          <div class="col-md-12">
            <div class="form-group">
              ...
              <select class="form-control custom-select" id="role_access_modal" name="role_access" data-plugin="select_hrm" data-placeholder="_">
                <option value="">&nbsp;</option>
...
{ id: "", class: "role-checkbox-modal custom-control-input", text: "Date Attendance Report", check: "<?php if(isset($_GET['role_id'])) { if(in_array('30',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>", add_info: "View", value: "30",},
