        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              ...
              <select class="select2" data-plugin="select_hrm" data-placeholder="_" name="type">
                <option value=""></option>
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input class="form-control" placeholder="_" name="subject" type="text" value="<?php echo $subject;?>">
            </div>
          </div>
        </div>
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input class="form-control d_date" placeholder="_" readonly name="warning_date" type="text" value="<?php echo $warning_date;?>">
            </div>
          </div>
        </div>
      </div>
