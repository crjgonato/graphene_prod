    ...
    <table class="table table-condensed table-hover m-md-b-0">
      <tbody>
        ...
        <tr>
          ...
          <td class="text-right"><?php echo $this->Graphene_model->currency_sign($training_cost);?></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td class="text-right"><?php echo $this->Graphene_model->set_date_format($finish_date);?></td>
        </tr>
        <tr>
