...
<div class="modal-header">
  ...
  <h4 class="modal-title" id="edit-modal-data"><?php echo $this->lang->line('graphene_edit_announcement');?></h4>
</div>
<form class="m-b-1" action="<?php echo site_url("announcement/update").'/'.$announcement_id; ?>" method="post" name="edit_announcement" id="edit_announcement">
  ...
  <div class="modal-body">
    <div class="row">
      <div class="col-md-6">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="form-group">
              <label for="designation" class="control-label"><?php echo $this->lang->line('graphene_department');?></label>
    ...
    <div class="form-group">
      ...
      <textarea class="form-control" placeholder="<?php echo $this->lang->line('graphene_summary');?>" name="summary" cols="30" rows="3" id="summary"><?php echo $summary;?></textarea>
    </div>
  </div>
...
<div class="modal-header">
  <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">×</span> </button>
  <h4 class="modal-title" id="edit-modal-data"><?php echo $this->lang->line('graphene_view_announcement');?></h4>
</div>
<form class="m-b-1">
  <div class="modal-body">
    <div class="row">
      <div class="col-md-6">
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              <label for="start_date"><?php echo $this->lang->line('graphene_error_start_date');?></label>
              <input class="form-control d_date" readonly="readonly" style="border:0" type="text" value="<?php echo $start_date;?>">
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
              <label for="end_date"><?php echo $this->lang->line('graphene_error_end_date');?></label>
      ...
      <div class="col-md-6">
        <div class="form-group">
          <label for="description"><?php echo $this->lang->line('graphene_description');?></label><br />
          <?php echo html_entity_decode($description);?>
        </div>
      </div>
    </div>
    <div class="form-group">
      <label for="summary"><?php echo $this->lang->line('graphene_summary');?></label><br />
