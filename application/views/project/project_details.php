...
<?php $u_created = $this->Graphene_model->read_user_info($session['user_id']);?>
...
<div class="row m-b-1">
  <div class="col-md-4">
    <div class="box box-block bg-white">
      <h5><strong><?php echo $this->lang->line('graphene_project');?>: </strong> <?php echo $title;?></h5>
      <table class="table table-condensed table-hover m-md-b-0">
        <tbody>
          <tr>
            <th scope="row"><?php echo $this->lang->line('dashboard_graphene_status');?></th>
            <td class="text-right"><?php echo $nstatus;?></td>
          </tr>
          <tr>
            <th scope="row"><?php echo $this->lang->line('graphene_start_date');?></th>
            <td class="text-right"><?php echo $this->Graphene_model->set_date_format($start_date);?></td>
          </tr>
          <tr>
            <th scope="row"><?php echo $this->lang->line('graphene_end_date');?></th>
            <td class="text-right"><?php echo $this->Graphene_model->set_date_format($end_date);?></td>
          </tr>
          <tr>
            <th scope="row"><?php echo $this->lang->line('graphene_createdp');?></th>
            <td class="text-right"><?php echo $this->Graphene_model->set_date_format($created_at);?></td>
          </tr>
          <tr>
    ...
    <!-- assigned to-->
    <div class="box box-block bg-white">
      <h5><?php echo $this->lang->line('graphene_project_users');?></h5>
      <div class="row">
        <form action="<?php echo site_url("project/assign_project") ?>" method="post" name="assign_project" id="assign_project">
          <input type="hidden" name="project_id" id="project_id" value="<?php echo $project_id;?>">
          <div class="box-block">
            <div class="form-group">
              <label for="employees" class="control-label"><?php echo $this->lang->line('graphene_employee');?></label>
              <select multiple class="form-control" name="assigned_to[]" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('graphene_employee');?>">
    ...
    <div class="box box-block bg-white">
      <div class="wizard" role="tabpanel">
        ...
        <div class="tab-content m-b-1">
          <div role="tabpanel" class="tab-pane animated fadeInUp active fade in" id="detail" style="overflow:auto;">
            <div class="info">
            ...
            <div class="col-md-6">
              ...
              <div class="items-list" id="all_employees_list">
                ...
                <?php $e_name = $this->Graphene_model->read_user_info($assign_id);?>
