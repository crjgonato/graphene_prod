    ...
    <div class="row">
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input class="form-control" placeholder="_" name="title" type="text" value="<?php echo $title;?>">
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
              <label for="complaint_date">Complaint Date</label>
              <input class="form-control d_date" placeholder="_" readonly name="complaint_date" type="text" value="<?php echo $complaint_date;?>">
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-md-12">
            <div class="form-group">
              ...
              <select multiple class="select2" data-plugin="select_hrm" data-placeholder="_" name="complaint_against[]">
                <option value=""></option>
                <?php foreach($all_employees as $employee) {?>
      ...
      <div class="col-md-6">
        <div class="form-group">
          ...
          <textarea class="form-control textarea" placeholder="_" name="description" cols="30" rows="10" id="description2"><?php echo $description;?></textarea>
        </div>
      </div>
    </div>
    <div class="row">
      <div class="col-md-6">
        <div class="form-group">
          ...
          <select name="status" id="select2-demo-6" class="form-control" data-plugin="select_hrm" data-placeholder="_">
