...
<div class="modal-header">
  ...
  <h4 class="modal-title" id="edit-modal-data"><?php echo $this->lang->line('graphene_edit_policy');?></h4>
</div>
<form class="m-b-1" action="<?php echo site_url("policy/update").'/'.$policy_id; ?>" method="post" name="edit_policy" id="edit_policy">
  ...
  <div class="modal-body">
    <div class="form-group">
      ...
      <select class="select2" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('graphene_select_company');?>..." name="company">
        <option value="0"><?php echo $this->lang->line('graphene_all_companies');?></option>
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" name="title" placeholder="<?php echo $this->lang->line('graphene_title');?>" value="<?php echo $title;?>">
    </div>
    <div class="form-group">
      <label for="message"><?php echo $this->lang->line('graphene_description');?></label>
      <textarea class="form-control" placeholder="<?php echo $this->lang->line('graphene_description');?>" name="description" id="description2"><?php echo $description;?></textarea>
    </div>
  </div>
...
<div class="modal-header">
  <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">×</span> </button>
  <h4 class="modal-title" id="edit-modal-data"><?php echo $this->lang->line('graphene_view_policy');?></h4>
</div>
<form class="m-b-1">
  <div class="modal-body">
    <div class="form-group">
