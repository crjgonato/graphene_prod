...
<div class="modal-header">
  ...
  <h4 class="modal-title" id="edit-modal-data"><?php echo $this->lang->line('graphene_designation_edit');?></h4>
</div>
     ...
     <div class="row">
      <div class="col-md-6">
        <div class="form-group">
          ...
          <select name="department_id" id="select2-demo-6" class="form-control" data-plugin="select_hrm" data-placeholder="_">
            <option value=""></option>
      ...
      <div class="col-md-6">
        <h6><?php echo $this->lang->line('graphene_designation');?></h6>
        <input type="text" class="form-control" placeholder="_" name="designation_name" value="<?php echo $designation_name;?>">
      </div>
    </div>
  </div>
