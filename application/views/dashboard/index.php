...
$role = $this->Graphene_model->read_user_role_info($user_info[0]->user_role_id);
// get designation
...
<!-- <div class="box box-block bg-white">
  <div class="t-content bold">News :</div>  
</div> -->
<!-- end -->
<?php if($user_info[0]->user_role_id=='1' || $user_info[0]->user_role_id=='3'){?>
<div class="row row-md mb-1 animated fadeInUp">
  <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
    <div class="box box-block tile tile-2 bg-white mb-2">
      <div class="t-icon right"><i class="fa fa-user"></i></div>
      <div class="t-content">
        <h1 class="mb-1 withellipsis"><?php echo $this->Employees_model->get_total_employees();?></h1>
        <h6 class="text-uppercase text-info"><?php echo $this->lang->line('dashboard_total_employees');?></h6>
      </div>
    </div>
  </div>
  <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
    <div class="box box-block tile tile-2 bg-white mb-2">
      <div class="t-icon right"><i class="ti-timer"></i></div>
      <div class="t-content">
        <h1 class="mb-1 withellipsis"><?php echo $this->Employees_model->get_present_employees();?> </h1>
        <h6 class="text-uppercase text-info"> ClockedIn Employee</h6>
      </div>
    </div>
  </div>
  <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
    <div class="box box-block tile tile-2 bg-white mb-2">
      ...
      <div class="t-content">
        <h1 class="mb-1 withellipsis"><?php echo $this->Graphene_model->get_all_departments();?></h1>
        <h6 class="text-uppercase text-info"><?php echo $this->lang->line('dashboard_departments');?></h6>
      </div>
    </div>
  </div>
  <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
    <div class="box box-block tile tile-2 bg-white mb-2">
      <div class="t-icon right"><i class="ti-notepad"></i></div>
      <div class="t-content">
        <h1 class="mb-1 withellipsis"><?php echo $this->Employees_model->get_present_holidays();?></h1>
        <h6 class="text-uppercase text-info"><?php echo date('F'); ?> Holidays</h6>
      </div>
    </div>
  </div>
  <!-- <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
    <div class="box box-block tile tile-2 bg-warning mb-2">
      ...
      <div class="t-content">
        <h1 class="mb-1"><//?php echo $this->Graphene_model->get_all_jobs();?></h1>
...
<div class="row row-md mb-1 animated fadeInUp">
  <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
    <div class="box box-block bg-white tile tile-3 sdl-tile mb-2">
      <div class="t-icon right"><i class="ti-layout-cta-right"></i></div>
      <div class="t-content"> <span class="text-uppercase text-default"><?php echo $this->lang->line('dashboard_total_salaries');?></span>
        <h1 class="mb-0 withellipsis"><?php $all_sal = $this->Graphene_model->get_total_salaries_paid();?>
          <?php echo $this->Graphene_model->currency_sign($all_sal[0]->paid_amount);?></h1>
      </div>
    </div>
  </div>
  <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
    <div class="box box-block bg-white tile tile-3 payroll-tile mb-2">
      ...
      <div class="t-content"> <span class="text-uppercase text-default"><?php echo $this->lang->line('dashboard_total_expenses');?></span>
        <h1 class="mb-0 withellipsis"><?php $exp_am = $this->Expense_model->get_total_expenses();?>
          <?php echo $this->Graphene_model->currency_sign($exp_am[0]->exp_amount);?></h1>
      </div>
    </div>
  </div>
  <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
    <div class="box box-block bg-white tile tile-3 payroll-tile mb-2">
      <div class="t-icon right"><i class="ti-location-pin"></i></div>
      <div class="t-content"> <span class="text-uppercase text-default"><?php echo $this->lang->line('dashboard_locations');?></span>
        <h1 class="mb-0 withellipsis"><?php echo $this->Graphene_model->get_all_locations();?></h1>
      </div>
    </div>
  </div>
  <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
    <div class="box box-block bg-white tile tile-3 payroll-tile mb-2">
      ...
      <div class="t-content"> <span class="text-uppercase text-default"><?php echo $this->lang->line('dashboard_companies');?></span>
        <h1 class="mb-0 withellipsis"><?php echo $this->Graphene_model->get_all_companies();?></h1>
      </div>
    </div>
  </div>
...
<div class="row row-md mb-1  animated fadeInUp">
  ...
  <div class="col-md-3">
    <div class="box bg-white user-1">
      ...
      <div class="u-content">
        ...
        <p class="text-muted pb-0-5"><?php echo $this->lang->line('dashboard_last_login');?>: <?php echo $this->Graphene_model->set_date_format($user_info[0]->last_login_date).' '.$last_login->format('h:i a');?></p>
  ...
  <div class="col-md-5">
    <div class="card box box-block bg-white">
      ...
      <div class="add-record-btn">
          ...
          <a href="<?php echo site_url();?>employees" class="btn btn-sm btn-default"><?php echo $this->lang->line('dashboard_show_more');?> <i class="fa fa-angle-right icon"></i></a>
        </div>
      <?php foreach($last_eight_employees as $employee) {?>
      <?php 
		if($employee->profile_picture!='' && $employee->profile_picture!='no file') {
			$de_file = 'uploads/profile/'.$employee->profile_picture;
		} else { 
			if($employee->gender=='Male') {  
			$de_file = 'uploads/profile/default_male.png'; 
			} else {  
			$de_file = 'uploads/profile/default_female.png';
			}
		}
      ...
      <div class="items-list">
        <div class="il-item" style=""> <a class="text-black" href="<?php echo site_url();?>employees/detail/<?php echo $employee->user_id;?>/">
          <div class="media">
            <div class="media-left">
              <div class="avatar box-48"> <img class="img-fluid b-a-radius-circle" draggable="false" src="<?php echo base_url().$de_file;?>" alt=""> </div>
            </div>
  ...
  <div class="col-md-4">
    <div class="box box-block bg-white">
      ...
      <div class="table-responsive" data-pattern="priority-columns">
        <table width="" class="table table-condensed table-hover m-md-b-0">
          <tbody>
            <tr>
            ...
            <tr>
              ...
              <td class="hidetext"><?php echo $password;?></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td><?php echo $this->Graphene_model->set_date_format($date_of_birth);?></td>
            </tr>
            <tr>
            ...
            <tr>
              <td colspan="2"><?php echo $office_shift;?></td>
            </tr>
          </tbody>
        </table>
      </div>
            ...
            <table class="table table-hover table-grey-head mb-md-0">
              <thead>
                <tr>
                  ...
                  <th><?php echo $this->lang->line('dashboard_graphene_progress');?></th>
                </tr>
              </thead>
              <tbody>
              ...
              foreach($aim as $dIds) {
                if($session['user_id'] === $dIds) {
                  $dId[] = $session['user_id']; 
              // project date		
              $pdate = $this->Graphene_model->set_date_format($pj->end_date);
              // project progress
  ...
  <div class="col-md-8">
    ...
    <input readonly id="attendance_date" name="attendance_date" type="hidden" value="<?php echo date('Y-m-d');?>">
      <h2><strong><?php echo $this->lang->line('dashboard_today_attendance');?> - <span id="att_date"> <?php echo $edate = $this->Graphene_model->set_date_format(date('d M, Y'));?></strong></span> </h2>
      <div class="table-responsive" data-pattern="priority-columns">
    ...
    <div class="card box box-block bg-white">
      ...
      <div class="">
        <div class="notifications">
          ...
          <?php $candidate = $this->Graphene_model->read_user_info($job_apps->user_id);?>
...
<div class="row row-md mb-1">
      ...
      <div class="table-responsive" data-pattern="priority-columns">
        <table class="table table-hover table-grey-head mb-md-0">
          <thead>
            <tr>
              <th><?php echo $this->lang->line('dashboard_graphene_title');?></th>
              <th><?php echo $this->lang->line('dashboard_graphene_end_date');?></th>
              <th><?php echo $this->lang->line('dashboard_graphene_status');?></th>
              <th><?php echo $this->lang->line('dashboard_graphene_progress');?></th>
            </tr>
          </thead>
            ...
            <?php $dId = array(); $i=1; foreach($task->result() as $et):
                 ...
                 foreach($aim as $dIds) {
                     if($session['user_id'] === $dIds) {
                        $dId[] = $session['user_id'];
                // task end date		
                $tdate = $this->Graphene_model->set_date_format($et->end_date);
                // task progress
    ...
    <div class="box box-block bg-white tile tile-3 mb-2">
      <div class="t-content">
        ...
        <?php
                    ...
                    ?>
        <h1 class="mb-0"><?php echo ($this->Graphene_model->current_month_attendance());?>/<?php echo $numDays;?></h1>
      </div>
    </div>
  </div>
  <div class="col-md-3">
    <div class="box box-block bg-white tile tile-3 mb-2">
      <div class="t-content">
        ...
        <h1 class="mb-0"><?php echo ($this->Graphene_model->total_employee_awards());?></h1>
      </div>
    </div>
  </div>
  <div class="col-md-3">
          ...
          <?php
             ...
             foreach($aim as $dIds) {
                 if($designation[0]->designation_id === $dIds) {
                    ...
                    $andate = $this->Graphene_model->set_date_format($an->created_at);
             ?>
          <div class="n-item" style="margin-bottom: 0;">
            <div class="media">
              <div class="media-body">
  ...
  <div class="col-md-3">
    <div class="card box box-block bg-white" style="overflow-y: overlay; height: 242px;">
      ...
      <div class="">
        <div>
          <?php $i=1; foreach($this->Graphene_model->get_employee_awards() as $emp_award):
              $aw_name = $this->Awards_model->read_award_type_information($emp_award->award_type_id);
              $awdate = $this->Graphene_model->set_date_format($emp_award->created_at);
             ?>
          <div class="n-item" style="margin-bottom: 0;">
            <div class="media">
              <div class="media-body">
