...
<div class="modal-header">
  ...
  <h4 class="modal-title" id="edit-modal-data"><?php echo $this->lang->line('graphene_department_edit');?></h4>
</div>
<form class="m-b-1" action="<?php echo site_url("department/update").'/'.$department_id; ?>" method="post" name="edit_department" id="edit_department">
  ...
  <div class="modal-body">
      <div class="form-group">
        <label for="department-name" class="form-control-label"><?php echo $this->lang->line('graphene_department_name');?>:</label>
        <input type="text" class="form-control" placeholder="_" name="department_name" value="<?php echo $department_name?>">
      </div>
      <div class="form-group">
          <label for="name"><?php echo $this->lang->line('graphene_location');?></label>
          <select name="location_id" id="select2-demo-6" class="form-control" data-plugin="select_hrm" data-placeholder="_">
        <option value=""></option>
        ...
        <div class="form-group">
          <label for="name"><?php echo $this->lang->line('graphene_department_head');?></label>
          <select name="employee_id" id="select2-demo-6" class="form-control" data-plugin="select_hrm" data-placeholder="_">
        <option value=""></option>
