...
<div class="row m-b-1">
  <div class="col-md-3">
    <div class="box bg-white">
      <ul class="nav nav-4">
        <li class="nav-item nav-item-link" id="config_8"> <a class="nav-link nav-tabs-link" href="#contract" data-config="8" data-config-block="contract" data-toggle="tab" aria-expanded="true"> <i class="fa fa-pencil"></i> Contract Type </a> </li>
          ...
          <div class="box-block bg-white">
            ...
            <form class="m-b-1 add" id="contract_type_info" action="<?php echo site_url("settings/contract_type_info") ?>" name="contract_type_info" method="post">
              <div class="form-group">
                <label for="name">Contract Type <font color="red">*</font></label>
                <input type="text" class="form-control" name="contract_type" placeholder="_">
              </div>
        ...
        <div class="col-md-7">
          <div class="box-block bg-white">
            ...
            <div class="table-responsive" data-pattern="priority-columns">
              <table class="table table-condensed table-hover table-bordered dataTable" id="xin_table_contract_type" style="width:100%;">
                <thead>
                  <tr>
                    <th>Action</th>
                    <th>Contract Type</th>
  ...
  <div class="col-md-9 current-tab animated fadeInUp" id="document_type" style="display:none;">
    <div  class="box-block bg-white">
      <div class="row">
        <div class="col-md-4">
          <div class=" box-block bg-white">
            ...
            <form class="m-b-1 add" id="document_type_info" action="<?php echo site_url("settings/document_type_info") ?>" name="document_type_info" method="post">
              <div class="form-group">
                <label for="name">Document Type <font color="red">*</font></label>
                <input type="text" class="form-control" name="document_type" placeholder="_">
              </div>
              <button type="submit" class="btn btn-primary save">Save</button>
            </form>
          </div>
        ...
        <div class="col-md-8">
          <div class="box-block bg-white">
            ...
            <div class="table-responsive" data-pattern="priority-columns">
              <table class="table table-condensed table-hover table-bordered dataTable" id="xin_table_document_type" style="width:100%;">
                <thead>
                  <tr>
                    <th>Action</th>
                    <th>Document Type</th>
      ...
      <div class="row">
        <div class="col-md-5">
          <div class="box-block bg-white">
            ...
            <form class="m-b-1 add" id="edu_level_info" action="<?php echo site_url("settings/edu_level_info") ?>" name="edu_level_info" method="post">
              <div class="form-group">
                <label for="name">Education Level <font color="red">*</font></label>
                <input type="text" class="form-control" name="name" placeholder="_">
              </div>
              <button type="submit" class="btn btn-primary save">Save</button>
            </form>
          </div>
        ...
        <div class="col-md-7">
          <div class="box-block bg-white">
            ...
            <div class="table-responsive" data-pattern="priority-columns">
              <table class="table table-condensed table-hover table-bordered dataTable" id="xin_table_education_level" style="width:100%;">
                <thead>
                  <tr>
                    <th>Action</th>
      ...
      <div class="row">
        <div class="col-md-5">
          <div class="box-block bg-white">
            ...
            <form class="m-b-1 add" id="edu_language_info" action="<?php echo site_url("settings/edu_language_info") ?>" name="edu_language_info" method="post">
              <div class="form-group">
                <label for="name">Language <font color="red">*</font></label>
                <input type="text" class="form-control" name="name" placeholder="_">
              </div>
              <button type="submit" class="btn btn-primary save">Save</button>
            </form>
        ...
        <div class="col-md-7">
          <div class="box-block bg-white">
            ...
            <div class="table-responsive" data-pattern="priority-columns">
              <table class="table table-condensed table-hover table-bordered dataTable" id="xin_table_qualification_language" style="width:100%;">
                <thead>
                  <tr>
                    <th>Action</th>
                    <th>Language</th>
      ...
      <div class="row">
        <div class="col-md-5">
          <div class="box-block bg-white">
            ...
            <form class="m-b-1 add" id="edu_skill_info" action="<?php echo site_url("settings/edu_skill_info") ?>" name="edu_skill_info" method="post">
              <div class="form-group">
                <label for="name">Skill <font color="red">*</font></label>
                <input type="text" class="form-control" name="name" placeholder="_">
              </div>
              <button type="submit" class="btn btn-primary save">Save</button>
            </form>
        ...
        <div class="col-md-7">
          <div class="box-block bg-white">
            ...
            <div class="table-responsive" data-pattern="priority-columns">
              <table class="table table-condensed table-hover table-bordered dataTable" id="xin_table_qualification_skill" style="width:100%;">
                <thead>
                  <tr>
                    <th>Action</th>
                    <th>Skill</th>
  ...
  <div class="col-md-9 current-tab animated fadeInUp" id="payment_method" style="display:none;">
    <div  class="box box-block bg-white">
      <div class="row">
        <div class="col-md-5">
          <div class="box-block bg-white">
            ...
            <form class="m-b-1 add" id="payment_method_info" action="<?php echo site_url("settings/payment_method_info") ?>" name="payment_method_info" method="post">
              <div class="form-group">
                <label for="name">Payment Method <font color="red">*</font></label>
                <input type="text" class="form-control" name="payment_method" placeholder="_">
              </div>
              <button type="submit" class="btn btn-primary save">Save</button>
            </form>
          </div>
        ...
        <div class="col-md-7">
          <div class="box-block bg-white">
            ...
            <div class="table-responsive" data-pattern="priority-columns">
              <table class="table table-condensed table-hover table-bordered dataTable" id="xin_table_payment_method" style="width:100%;">
                <thead>
                  <tr>
                    <th>Action</th>
  ...
  <div class="col-md-9 current-tab animated fadeInUp" id="award_type" style="display:none;">
    <div  class="box box-block bg-white">
      <div class="row">
        <div class="col-md-5">
          <div class="box-block bg-white">
            ...
            <form class="m-b-1 add" id="award_type_info" action="<?php echo site_url("settings/award_type_info") ?>" name="award_type_info" method="post">
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="award_type" placeholder="_">
              </div>
              <button type="submit" class="btn btn-primary save">Save</button>
            </form>
          </div>
        ...
        <div class="col-md-7">
          <div class="box-block bg-white">
            ...
            <div class="table-responsive" data-pattern="priority-columns">
              <table class="table table-condensed table-hover table-bordered dataTable" id="xin_table_award_type" style="width:100%;">
                <thead>
                  <tr>
                    <th>Action</th>
                    <th>Award Type</th>
  ...
  <div class="col-md-9 current-tab animated fadeInUp" id="leave_type" style="display:none;">
    <div  class="box box-block bg-white">
      <div class="row">
        <div class="col-md-5">
          <div class="box-block bg-white">
            ...
            <form class="m-b-1 add" id="leave_type_info" action="<?php echo site_url("settings/leave_type_info") ?>" name="leave_type_info" method="post">
              <div class="form-group">
                <label for="name">Leave Type <font color="red">*</font></label>
                <input type="text" class="form-control" name="leave_type" placeholder="_">
              </div>
              <div class="form-group">
                <label for="name">Days per Year <font color="red">*</font></label>
                <input type="text" class="form-control" name="days_per_year" placeholder="_">
              </div>
              <button type="submit" class="btn btn-primary save">Save</button>
            </form>
          </div>
        ...
        <div class="col-md-7">
          <div class="box-block bg-white">
            ...
            <div class="table-responsive" data-pattern="priority-columns">
              <table class="table table-condensed table-hover table-bordered dataTable" id="xin_table_leave_type" style="width:100%;">
                <thead>
                  <tr>
                    <th>Action</th>
                    <th>Leave Type</th>
  ...
  <div class="col-md-9 current-tab animated fadeInUp" id="warning_type" style="display:none;">
    <div  class="box box-block bg-white">
      <div class="row">
        <div class="col-md-5">
          <div class="box-block bg-white">
            ...
            <form class="m-b-1 add" id="warning_type_info" action="<?php echo site_url("settings/warning_type_info") ?>" name="warning_type_info" method="post">
              <div class="form-group">
                <label for="name">Warning Type <font color="red">*</font></label>
                <input type="text" class="form-control" name="warning_type" placeholder="_">
              </div>
              <button type="submit" class="btn btn-primary save">Save</button>
            </form>
          </div>
        ...
        <div class="col-md-7">
          <div class="box-block bg-white">
            ...
            <div class="table-responsive" data-pattern="priority-columns">
              <table class="table table-condensed table-hover table-bordered dataTable" id="xin_table_warning_type" style="width:100%;">
                <thead>
                  <tr>
                    <th>Action</th>
                    <th>Warning Type</th>
  ...
  <div class="col-md-9 current-tab animated fadeInUp" id="termination_type" style="display:none;">
    <div  class="box box-block bg-white">
      <div class="row">
        <div class="col-md-5">
          <div class="box-block bg-white">
            ...
            <form class="m-b-1 add" id="termination_type_info" action="<?php echo site_url("settings/termination_type_info") ?>" name="termination_type_info" method="post">
              <div class="form-group">
                <label for="name">Termination Type <font color="red">*</font></label>
                <input type="text" class="form-control" name="termination_type" placeholder="_">
              </div>
              <button type="submit" class="btn btn-primary save">Save</button>
            </form>
          </div>
        ...
        <div class="col-md-7">
          <div class="box-block bg-white">
            ...
            <div class="table-responsive" data-pattern="priority-columns">
              <table class="table table-condensed table-hover table-bordered dataTable" id="xin_table_termination_type" style="width:100%;">
                <thead>
                  <tr>
                    <th>Action</th>
  ...
  <div class="col-md-9 current-tab animated fadeInUp" id="expense_type" style="display:none;">
    <div  class="box box-block bg-white">
      <div class="row">
        <div class="col-md-5">
          <div class="box-block bg-white">
            ...
            <form class="m-b-1 add" id="expense_type_info" action="<?php echo site_url("settings/expense_type_info") ?>" name="expense_type_info" method="post">
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="expense_type" placeholder="_">
              </div>
              <button type="submit" class="btn btn-primary save">Save</button>
            </form>
          </div>
        ...
        <div class="col-md-7">
          <div class="box-block bg-white">
            ...
            <div class="table-responsive" data-pattern="priority-columns">
              <table class="table table-condensed table-hover table-bordered dataTable" id="xin_table_expense_type" style="width:100%;">
                <thead>
                  <tr>
                    <th>Action</th>
                    <th>Expense Type</th>
  ...
  <div class="col-md-9 current-tab animated fadeInUp" id="job_type" style="display:none;">
    <div  class="box box-block bg-white">
      <div class="row">
        <div class="col-md-5">
          <div class="box-block bg-white">
            ...
            <form class="m-b-1 add" id="job_type_info" action="<?php echo site_url("settings/job_type_info") ?>" name="job_type_info" method="post">
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="job_type" placeholder="_">
              </div>
              <button type="submit" class="btn btn-primary save">Save</button>
            </form>
          </div>
        ...
        <div class="col-md-7">
          <div class="box-block bg-white">
            ...
            <div class="table-responsive" data-pattern="priority-columns">
              <table class="table table-condensed table-hover table-bordered dataTable" id="xin_table_job_type" style="width:100%;">
                <thead>
                  <tr>
                    <th>Action</th>
                    <th>Job Type</th>
  ...
  <div class="col-md-9 current-tab animated fadeInUp" id="exit_type" style="display:none;">
    <div  class="box box-block bg-white">
      <div class="row">
        <div class="col-md-5">
          <div class="box-block bg-white">
            ...
            <form class="m-b-1 add" id="exit_type_info" action="<?php echo site_url("settings/exit_type_info") ?>" name="exit_type_info" method="post">
              <div class="form-group">
                <label for="name">Employee Exit Type <font color="red">*</font></label>
                <input type="text" class="form-control" name="exit_type" placeholder="_">
              </div>
              <button type="submit" class="btn btn-primary save">Save</button>
            </form>
          </div>
        ...
        <div class="col-md-7">
          <div class="box-block bg-white">
            ...
            <div class="table-responsive" data-pattern="priority-columns">
              <table class="table table-condensed table-hover table-bordered dataTable" id="xin_table_exit_type" style="width:100%;">
                <thead>
                  <tr>
                    <th>Action</th>
  ...
  <div class="col-md-9 current-tab animated fadeInUp" id="travel_arr_type" style="display:none;">
    <div  class="box box-block bg-white">
      <div class="row">
        <div class="col-md-5">
          <div class="box-block bg-white">
            ...
            <form class="m-b-1 add" id="travel_arr_type_info" action="<?php echo site_url("settings/travel_arr_type_info") ?>" name="travel_arr_type_info" method="post">
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="travel_arr_type" placeholder="_">
              </div>
              <button type="submit" class="btn btn-primary save">Save</button>
            </form>
          </div>
        ...
        <div class="col-md-7">
          <div class="box-block bg-white">
            ...
            <div class="table-responsive" data-pattern="priority-columns">
              <table class="table table-condensed table-hover table-bordered dataTable" id="xin_table_travel_arr_type" style="width:100%;">
                <thead>
                  <tr>
                    <th>Action</th>
  ...
  <div class="col-md-9 current-tab animated fadeInUp" id="currency_type" style="display:none;">
    <div  class="box box-block bg-white">
      <div class="row">
        <div class="col-md-5">
          <div class="box-block bg-white">
            ...
            <form class="m-b-1 add" id="currency_type_info" action="<?php echo site_url("settings/currency_type_info") ?>" name="currency_type_info" method="post">
              <div class="form-group">
                <label for="name">Currency Name <font color="red">*</font></label>
                <input type="text" class="form-control" name="name" placeholder="_">
              </div>
              <div class="form-group">
                <label for="name">Currency Code <font color="red">*</font></label>
                <input type="text" class="form-control" name="code" placeholder="_">
              </div>
              <div class="form-group">
                <label for="name">Currency Symbol <font color="red">*</font></label>
                <input type="text" class="form-control" name="symbol" placeholder="_">
              </div>
              <button type="submit" class="btn btn-primary save">Save</button>
            </form>
          </div>
        ...
        <div class="col-md-7">
          <div class="box-block bg-white">
            ...
            <div class="table-responsive" data-pattern="priority-columns">
              <table class="table table-condensed table-hover table-bordered dataTable" id="xin_table_currency_type" style="width:100%;">
                <thead>
                  <tr>
                    <th>Action</th>
                    <th>Name</th>
