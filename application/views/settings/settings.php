...
<div class="row m-b-1">
  <div class="col-md-3">
    <div class="box bg-white">
      <ul class="nav nav-4">
        ...
        <li class="nav-item nav-item-link" id="config_1"> <a class="nav-link nav-tabs-link" href="#general" data-config="1" data-config-block="general" data-toggle="tab" aria-expanded="true"> <i class="fa fa-cog"></i> General </a> </li>
  ...
  <div class="col-md-9 current-tab animated fadeInUp" id="general" style="display:none;">
        ...
        <div class="row">
          <div class="col-sm-6">
            <div class="form-group">
              ...
              <input class="form-control" placeholder="_" name="company_name" type="text" value="<?php echo $company_name;?>">
            </div>
            <div class="form-group">
              <label for="contact_person">Contact Person <font color="red">*</font></label>
              <input class="form-control" placeholder="_" name="contact_person" type="text" value="<?php echo $contact_person;?>">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input class="form-control" placeholder="_" name="phone" type="number" value="<?php echo $phone;?>">
            </div>
          </div>
          <div class="col-sm-6">
            <div class="form-group">
              <label for="address">Address <font color="red">*</font></label>
              <input class="form-control" placeholder="Address 1" name="address_1" type="text" value="<?php echo $address_1;?>">
              <br>
              <input class="form-control" placeholder="Address 2" name="address_2" type="text" value="<?php echo $address_2;?>">
              <br>
              <div class="row">
                <div class="col-xs-5">
  ...
  <div class="col-md-9 current-tab animated fadeInUp" id="company_logo" style="display:none;">
    <div class="box box-block bg-white">
      <form id="logo_info" action="<?php echo site_url("settings/logo_info").'/'.$company_info_id ?>/" name="logo_info" method="post">
        ...
        <div class="row">
          <div class="col-md-6">
            <div class='form-group'>
              <h6>First Logo <font color="red">*</font></h6>
          ...
          <div class="col-md-6">
            <div class='form-group'>
              <h6>Second Logo <font color="red">*</font></h6>
              <span class="btn btn-primary btn-file"> Browse
    ...
    <div class="box box-block bg-white">
      <form id="singin_logo" name="singin_logo" method="post" enctype="multipart/form-data">
        ...
        <div class="row">
          <div class="col-md-6">
            <div class='form-group'>
              <h6>Logo <font color="red">*</font></h6>
              <span class="btn btn-primary btn-file"> Browse
  ...
  <div class="col-md-9 current-tab animated fadeInUp" id="system" style="display:none;">
    <form id="system_info" action="<?php echo site_url("settings/system_info").'/'.$company_info_id ?>/" name="system_info" method="post">
      ...
      <div class="box box-block bg-white">
        ...
        <div class="col-sm-6">
          <div class="form-group">
            <label for="company_name">Application Name <font color="red">*</font></label>
            <input class="form-control" placeholder="_" name="application_name" type="text" value="<?php echo $application_name;?>" id="application_name">
          </div>
          <div class="form-group">
            <label for="email">Default Currency <font color="red">*</font></label>
            <select class="form-control select2-hidden-accessible" name="default_currency_symbol" data-plugin="select_hrm" data-placeholder="Default Currency Symbol" tabindex="-1" aria-hidden="true">
              <option value="">Select One</option>
              <?php foreach($this->Graphene_model->get_currencies() as $currency){?>
          ...
          <div class="form-group">
            <label for="phone">Default Currency (Symbol/Code) <font color="red">*</font></label>
          ...
          <div class="form-group">
            <label for="phone">Currency Position <font color="red">*</font></label>
            ...
            <select class="form-control" name="currency_position" data-plugin="select_hrm" data-placeholder="_">
              <option value="">Select One</option>
          ...
          <div class="form-group">
            <label for="contact_role">Enable page rendered on footer </label>
            <br>
        ...
        <div class="col-sm-6">
          ...
          <div class="form-group">
            <label for="footer_text">Footer Text <font color="red">*</font></label>
            <input class="form-control" placeholder="_" name="footer_text" type="text" value="<?php echo $footer_text;?>">
          </div>
          <div class="form-group">
  ...
  <div class="col-md-9 current-tab animated fadeInUp" id="role" style="display:none;">
  ...
  <div class="col-md-9 current-tab animated fadeInUp" id="attendance" style="display:none;">
  ...
  <div class="col-md-9 current-tab animated fadeInUp" id="payroll" style="display:none;">
    <div class="box box-block bg-white">
  ...
  <div class="col-md-9 current-tab animated fadeInUp" id="job" style="display:none;">
    <div class="box box-block bg-white">
  ...
  <div class="col-md-9 current-tab animated fadeInUp" id="email" style="display:none;">
  ...
  <div class="col-md-9 current-tab animated fadeInUp" id="animation"  aria-expanded="false" style="display:none;">
    <div class="box box-block bg-white">
          ...
          <div class="col-md-12">
            <div class="col-sm-6">
              ...
              <div class="form-group">
                ...
                <br />
                <p class="text-muted">Set animation effect for top menu.</p>
            ...
            <div class="col-sm-6">
              ...
              <div class="form-group">
                ...
                <br />
                <p class="text-muted">Set animation effect for modal dialogs.</p>
              </div>
            </div>
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  <div class="text-right">
                    <button type="submit" class="btn btn-primary save col-right"><?php echo $this->lang->line('graphene_save');?> <i class="icon-circle-right2 position-right"></i> <i class="icon-spinner3 spinner position-left"></i></button>
                  </div>
                </div>
              </div>
            </div>
  ...
  <div class="col-md-9 current-tab animated fadeInUp" id="notification" style="display:none;">
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="form-group">
              ...
              <br />
              <p class="text-muted"><i class="icon-arrow-up8"></i> Set position for notifications.</p> </div>
          </div>
          <div class="col-md-3">
            <div class="form-group">
