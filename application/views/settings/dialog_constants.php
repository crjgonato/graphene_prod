...
$row = $this->Graphene_model->read_document_type($_GET['field_id']);
?>
...
<form class="m-b-1" action="<?php echo site_url("settings/update_document_type") ?>/<?php echo $row[0]->document_type_id;?>/" method="post" name="ed_document_type_info" id="ed_document_type_info">
  ...
  <div class="modal-body">
      <div class="form-group">
        ...
        <input type="text" class="form-control" name="name" placeholder="_" value="<?php echo $row[0]->document_type;?>">
      </div>
    </div>
...
$row = $this->Graphene_model->read_contract_type($_GET['field_id']);
?>
<div class="modal-header">
  <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">×</span> </button>
...
<form class="m-b-1" action="<?php echo site_url("settings/update_contract_type") ?>/<?php echo $row[0]->contract_type_id;?>/" method="post" name="ed_contract_type_info" id="ed_contract_type_info">
  ...
  <div class="modal-body">
      <div class="form-group">
        ...
        <input type="text" class="form-control" name="name" placeholder="_" value="<?php echo $row[0]->name?>">
      </div>
    </div>
  <div class="modal-footer">
    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
...
$row = $this->Graphene_model->read_payment_method($_GET['field_id']);
?>
<div class="modal-header">
  <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">×</span> </button>
...
<form class="m-b-1" action="<?php echo site_url("settings/update_payment_method") ?>/<?php echo $row[0]->payment_method_id;?>/" method="post" name="ed_payment_method_info" id="ed_payment_method_info">
  ...
  <div class="modal-body">
      <div class="form-group">
        ...
        <input type="text" class="form-control" name="name" placeholder="_" value="<?php echo $row[0]->method_name;?>">
      </div>
    </div>
  <div class="modal-footer">
    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
...
$row = $this->Graphene_model->read_education_level($_GET['field_id']);
?>
<div class="modal-header">
  <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">×</span> </button>
...
$row = $this->Graphene_model->read_qualification_language($_GET['field_id']);
?>
<div class="modal-header">
  <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">×</span> </button>
...
$row = $this->Graphene_model->read_qualification_skill($_GET['field_id']);
?>
<div class="modal-header">
  <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">×</span> </button>
...
$row = $this->Graphene_model->read_award_type($_GET['field_id']);
?>
<div class="modal-header">
  <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">×</span> </button>
...
<form class="m-b-1" action="<?php echo site_url("settings/update_award_type") ?>/<?php echo $row[0]->award_type_id;?>/" method="post" name="ed_award_type_info" id="ed_award_type_info">
  ...
  <div class="modal-body">
      <div class="form-group">
        ...
        <input type="text" class="form-control" name="name" placeholder="_" value="<?php echo $row[0]->award_type;?>">
      </div>
    </div>
  <div class="modal-footer">
    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
...
$row = $this->Graphene_model->read_leave_type($_GET['field_id']);
?>
<div class="modal-header">
  <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">×</span> </button>
...
<form class="m-b-1" action="<?php echo site_url("settings/update_leave_type") ?>/<?php echo $row[0]->leave_type_id;?>/" method="post" name="ed_leave_type_info" id="ed_leave_type_info">
  ...
  <div class="modal-body">
      <div class="form-group">
        ...
        <input type="text" class="form-control" name="name" placeholder="_" value="<?php echo $row[0]->type_name;?>">
      </div>
      <div class="form-group">
...
$row = $this->Graphene_model->read_warning_type($_GET['field_id']);
?>
<div class="modal-header">
  <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">×</span> </button>
...
<form class="m-b-1" action="<?php echo site_url("settings/update_warning_type") ?>/<?php echo $row[0]->warning_type_id;?>/" method="post" name="ed_warning_type_info" id="ed_warning_type_info">
  ...
  <div class="modal-body">
      <div class="form-group">
        ...
        <input type="text" class="form-control" name="name" placeholder="_" value="<?php echo $row[0]->type;?>">
      </div>
    </div>
  <div class="modal-footer">
    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
...
$row = $this->Graphene_model->read_termination_type($_GET['field_id']);
?>
<div class="modal-header">
  <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">×</span> </button>
...
$row = $this->Graphene_model->read_expense_type($_GET['field_id']);
?>
<div class="modal-header">
  <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">×</span> </button>
...
$row = $this->Graphene_model->read_job_type($_GET['field_id']);
?>
<div class="modal-header">
  <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">×</span> </button>
...
$row = $this->Graphene_model->read_exit_type($_GET['field_id']);
?>
<div class="modal-header">
  <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">×</span> </button>
...
$row = $this->Graphene_model->read_travel_arr_type($_GET['field_id']);
?>
<div class="modal-header">
  <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">×</span> </button>
...
$row = $this->Graphene_model->read_currency_types($_GET['field_id']);
?>
<div class="modal-header">
  <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">×</span> </button>
...
<form class="m-b-1" action="<?php echo site_url("settings/update_currency_type") ?>/<?php echo $row[0]->currency_id;?>/" method="post" name="ed_currency_type_info" id="ed_currency_type_info">
  ...
  <div class="modal-body">
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" name="code" placeholder="_" value="<?php echo $row[0]->code;?>">
      </div>
      <div class="form-group">
        <label for="name">Currency Symbol</label>
        <input type="text" class="form-control" name="symbol" placeholder="_" value="<?php echo $row[0]->symbol;?>">
      </div>
    </div>
  <div class="modal-footer">
    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
...
<div class="modal-header">
  ...
  <div class="modal-body">
      <div class="form-group">
        ...
        <?php foreach($this->Graphene_model->all_policies() as $_policy):?>
                    ...
                    <h4 class="panel-title">
                        <a data-toggle="collapse" data-parent="#accordion" href="#collapse<?php echo $_policy->policy_id;?>" aria-expanded="true" aria-controls="collapseOne">
						 ...
						 if($_policy->company_id==0){
							...
							$company = $this->Graphene_model->read_company_info($_policy->company_id);
