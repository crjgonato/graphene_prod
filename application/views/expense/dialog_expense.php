...
<div class="modal-header">
  ...
  <h4 class="modal-title" id="edit-modal-data"><?php echo $this->lang->line('graphene_edit_expense');?></h4>
</div>
    ...
    <div class="row">
      <div class="col-md-6">
        <div class="form-group">
          <label for="employee"><?php echo $this->lang->line('expense_type');?></label>
          <select name="expense_type" id="select2-demo-6" class="form-control" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('graphene_choose_expense_type');?>...">
            <option value=""></option>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              <label for="purchase_date"><?php echo $this->lang->line('graphene_purchase_date');?></label>
              <input class="form-control edate" placeholder="<?php echo $this->lang->line('graphene_purchase_date');?>" readonly="true" name="purchase_date" type="text" value="<?php echo $purchase_date;?>">
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
              <label for="amount"><?php echo $this->lang->line('graphene_amount');?></label>
              <input class="form-control" placeholder="<?php echo $this->lang->line('graphene_amount');?>" name="amount" type="text" value="<?php echo $amount;?>">
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-md-12">
            <div class="form-group">
              <label for="gift"><?php echo $this->lang->line('graphene_purchased_by');?></label>
              <select name="employee_id" id="select2-demo-6" class="form-control" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('graphene_choose_an_employee');?>...">
                <option value=""></option>
      ...
      <div class="col-md-6">
        <div class="form-group">
          <label for="description"><?php echo $this->lang->line('graphene_remarks');?></label>
    ...
    <div class="row">
      <div class="col-md-6">
        <div class="form-group">
          ...
          <select name="status" id="select2-demo-6" class="form-control" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('dashboard_graphene_status');?>...">
      ...
      <div class="col-md-6">
        <div class='form-group'>
          <h6><?php echo $this->lang->line('graphene_bill_copy');?></h6>
          <span class="btn btn-primary btn-file">
            Browse <input type="file" name="bill_copy" id="bill_copy">
          </span>
          <br>
          <small><?php echo $this->lang->line('graphene_expense_allow_files');?></small>
          <?php if($billcopy_file!='' && $billcopy_file!='no file') {?>
          <br />
          <a href="<?php echo site_url("download?type=expense&filename=".$billcopy_file."") ?>"><?php echo $this->lang->line('graphene_download_file');?></a>
          <?php } ?>
        </div>
      </div>
    </div>
...
<div class="modal-header">
  <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">×</span> </button>
  <h4 class="modal-title" id="edit-modal-data"><?php echo $this->lang->line('graphene_view_expense');?></h4>
</div>
<form class="m-b-1">
  <div class="modal-body">
    <div class="row">
      <div class="col-md-6">
        <div class="form-group">
          <label for="type"><?php echo $this->lang->line('expense_type');?></label>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="form-group">
              <label for="graphene_purchased_by"><?php echo $this->lang->line('graphene_purchased_by');?></label>
