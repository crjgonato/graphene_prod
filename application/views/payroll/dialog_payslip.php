          ...
          <div class="row m-b-1">
            ...
            <div class="col-md-12">
              <div class="f">
                ...
                <?php echo $this->Graphene_model->currency_sign($gross_salary);?> </div>
            </div>
            <?php endif;?>
            ...
            <div class="col-md-12">
              <div class="f">
                ...
                <?php echo $this->Graphene_model->currency_sign($overtime_rate);?> </div>
            </div>
            <?php endif;?>
            <?php if($hourly_rate):?>
            <div class="col-md-12">
              <div class="f">
                ...
                <?php echo $this->Graphene_model->currency_sign($hourly_rate);?> </div>
            </div>
            <?php endif;?>
            ...
            <div class="row m-b-1">
              ...
              <div class="col-md-12">
                <div class="f">
                  ...
                  <?php echo $this->Graphene_model->currency_sign($house_rent_allowance);?> </div>
              </div>
              <?php endif;?>
              ...
              <div class="col-md-12">
                <div class="f">
                  ...
                  <?php echo $this->Graphene_model->currency_sign($medical_allowance);?> </div>
              </div>
              <?php endif;?>
              ...
              <div class="col-md-12">
                <div class="f">
                  ...
                  <?php echo $this->Graphene_model->currency_sign($travelling_allowance);?> </div>
              </div>
              <?php endif;?>
              ...
              <div class="col-md-12">
                <div class="f">
                  ...
                  <?php echo $this->Graphene_model->currency_sign($dearness_allowance);?> </div>
              </div>
              <?php endif;?>
            </div>
          </blockquote>
          ...
          <div class="row m-b-1">
            ...
            <div class="col-md-12">
              <div class="f">
                ...
                <?php echo $this->Graphene_model->currency_sign($provident_fund);?> </div>
            </div>
            <?php endif;?>
            ...
            <div class="col-md-12">
              <div class="f">
                ...
                <?php echo $this->Graphene_model->currency_sign($tax_deduction);?> </div>
            </div>
            <?php endif;?>
            ...
            <div class="col-md-12">
              <div class="f">
                ...
                <?php echo $this->Graphene_model->currency_sign($security_deposit);?> </div>
            </div>
            <?php endif;?>
          </div>
        </div>
          ...
          <div class="row m-b-1">
            ...
            <div class="col-md-12">
              <div class="f">
                ...
                <?php echo $this->Graphene_model->currency_sign($total_allowances);?> </div>
            </div>
            <?php endif;?>
            ...
            <div class="col-md-12">
              <div class="f">
                ...
                <?php echo $this->Graphene_model->currency_sign($total_deductions);?> </div>
            </div>
            <?php endif;?>
            <?php if($net_salary!=''): ?>
            <div class="col-md-12">
              <div class="f">
                ...
                <?php echo $this->Graphene_model->currency_sign($net_salary);?> </div>
            </div>
            <?php endif;?>
            <?php if($net_salary!=''): ?>
            <div class="col-md-12">
            ...
            <div class="col-md-12">
              <div class="f">
				...
				echo $this->Graphene_model->currency_sign($gsalary);?>
              </div>
            </div>
            <?php endif;?>
            <?php if($total_hours_work): ?>
            <div class="col-md-12">
              <div class="f">
				...
				echo $this->Graphene_model->currency_sign($hrs_salary);?>
              </div>
            </div>
            <?php endif;?>
            <?php if($total_hours_work): ?>
            <div class="col-md-12">
              <div class="f">
				...
				echo $this->Graphene_model->currency_sign($hrs_sal);?>
              </div>
            </div>
            <?php endif;?>
            <?php if($total_hours_work): ?>
