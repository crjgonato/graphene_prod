            ...
            <div class="row">
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input class="form-control" placeholder="_" name="salary_grades" type="text" value="<?php echo $salary_grades;?>">
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-group">
                  <label for="basic_salary" class="control-label">Basic Salary</label>
                  <input class="form-control pt" placeholder="_" name="basic_salary" type="text" value="<?php echo $basic_salary;?>" onkeyup="findpt()">
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-group">
                  <label for="overtime_rate" class="control-label">Overtime Rate ( Per Hour)</label>
                  <input class="form-control pt" placeholder="_" name="overtime_rate" type="text" value="<?php echo $overtime_rate;?>" onkeyup="findpt()">
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="row">
                <div class="col-md-6">
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          <label for="ssspremium">SSS Premium</label>
                          <input class="form-control pt" placeholder="_" name="ssspremium" type="text" value="<?php echo $ssspremium;?>" onkeyup="findpt()">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          <label for="philpremium">Philhealth Premium</label>
                          <input class="form-control pt" placeholder="_" name="philpremium" type="text" value="<?php echo $philpremium;?>" onkeyup="findpt()">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                          <label for="hdmfpremium">HDMF Premium</label>
                          <input class="form-control pt" placeholder="_" name="hdmfpremium" type="text" value="<?php echo $philpremium;?>" onkeyup="findpt()">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          <label for="sssloan">SSS Loan </label>
                          <input class="form-control pt" placeholder="_" name="sssloan" type="text" value="<?php echo $sssloan;?>" onkeyup="findpt()">
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input class="form-control pt" placeholder="_" name="hdmfloan" type="text" value="<?php echo $hdmfloan;?>" onkeyup="findpt()">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          <label for="wdholdingtax">Witholding Tax</label>
                          <input class="form-control pt" placeholder="_" name="wdholdingtax" type="text" value="<?php echo $wdholdingtax;?>" onkeyup="findpt()">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                          <label for="latepenalty">Lates Penalty</label>
                          <input class="form-control pt" placeholder="_" name="latepenalty" type="text" value="<?php echo $latepenalty;?>" onkeyup="findpt()">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          <label for="uniforms">Uniforms</label>
                          <input class="form-control pt" placeholder="_" name="uniforms" type="text" value="<?php echo $uniforms;?>" onkeyup="findpt()">
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input class="form-control pt" placeholder="_" name="drnumber" type="text" value="<?php echo $drnumber;?>" onkeyup="findpt()">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          <label for="others">Others</label>
                          <input class="form-control pt" placeholder="_" name="others" type="text" value="<?php echo $others;?>" onkeyup="findpt()">
                        </div>
                      </div>
                    </div>
                </div>
...
function findpt()
{
    ...
    document.getElementById('m_total').value = tot;
    document.getElementById('m_net_salary').value = tot;
}
</script>
...
if($profile_picture!='' && $profile_picture!='no file') {
	...
	if($gender=='Male') { 
		$u_file = 'uploads/profile/default_male.png';
	} else {
		$u_file = 'uploads/profile/default_female.png';
	}
} ?>
...
<div class="modal-body animated fadeInUp">
  ...
  <div class="row mb-1">
          ...
          <div class="row m-b-1">
            ...
            <div class="col-md-12">
              <div class="f">
                ...
                <?php echo $this->Graphene_model->currency_sign($grade_template[0]->basic_salary);?></div>
            </div>
            ...
            <div class="col-md-12">
              <div class="f">
                ...
                <?php echo $this->Graphene_model->currency_sign($grade_template[0]->overtime_rate);?> </div>
            </div>
            <?php endif;?>
            ...
            <div class="col-md-12">
              <div class="f">
                ...
                <span class="tag tag-danger"><?php echo $status ?></span></div>
            </div>
            <?php endif;?>
          </div>
        </div>
            ...
            <div class="row m-b-1">
              ...
              <div class="col-md-12">
                <div class="f">
                  ...
                  <?php echo $this->Graphene_model->currency_sign($grade_template[0]->house_rent_allowance);?></div>
              </div>
              <?php endif;?>
              ...
              <div class="col-md-12">
                <div class="f">
                  ...
                  <?php echo $this->Graphene_model->currency_sign($grade_template[0]->medical_allowance);?> </div>
              </div>
              <?php endif;?>
              ...
              <div class="col-md-12">
                <div class="f">
                  ...
                  <?php echo $this->Graphene_model->currency_sign($grade_template[0]->travelling_allowance);?> </div>
              </div>
              <?php endif;?>
              ...
              <div class="col-md-12">
                <div class="f">
                  ...
                  <?php echo $this->Graphene_model->currency_sign($grade_template[0]->dearness_allowance);?> </div>
              </div>
              <?php endif;?>
            </div>
          </blockquote>
          ...
          <div class="row m-b-1">
            ...
            <div class="col-md-12">
              <div class="f">
                ...
                <?php echo $this->Graphene_model->currency_sign($grade_template[0]->provident_fund);?> </div>
            </div>
            <?php endif;?>
            ...
            <div class="col-md-12">
              <div class="f">
                ...
                <?php echo $this->Graphene_model->currency_sign($grade_template[0]->tax_deduction);?> </div>
            </div>
            <?php endif;?>
            ...
            <div class="col-md-12">
              <div class="f">
                ...
                <?php echo $this->Graphene_model->currency_sign($grade_template[0]->security_deposit);?> </div>
            </div>
            <?php endif;?>
          </div>
        </div>
    ...
    <?php if(($grade_template[0]->ssspremium!='')){
		$col_sm = 'col-sm-12';
		$offset = 'offset-2md-3';
	  } else {
		$col_sm = 'col-sm-12';
          ...
          <div class="row m-b-1">
            ...
            <div class="col-md-12">
              <div class="f">
                ...
                <?php echo $this->Graphene_model->currency_sign($grade_template[0]->gross_salary);?> </div>
            </div>
            <?php endif;?>
            ...
            <div class="col-md-12">
              <div class="f">
                ...
                <?php echo $this->Graphene_model->currency_sign($grade_template[0]->total_allowance);?> </div>
            </div>
            <?php endif;?>
            ...
            <div class="col-md-12">
              <div class="f">
                ...
                <?php echo $this->Graphene_model->currency_sign($grade_template[0]->total_deduction);?> </div>
            </div>
            <?php endif;?> -->
            ...
            <div class="col-md-12">
              <div class="f">
                ...
                <?php echo $this->Graphene_model->currency_sign($grade_template[0]->net_salary);?> </div>
            </div>
            <?php endif;?>
          </div>
        </div>
          ...
          <div class="row m-b-1">
            ...
            <div class="col-md-12">
              <div class="f">
                ...
                <?php echo $this->Graphene_model->currency_sign($hourly_template[0]->hourly_rate);?> </div>
            </div>
            <?php if(isset($_GET['mode']) && $_GET['mode'] == 'not_paid'):?>
            <div class="col-md-12">
              <div class="f">
