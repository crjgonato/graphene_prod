...
<div class="modal-body">
  <form class="m-b-1" action="<?php echo site_url("payroll/add_pay_monthly") ?>" method="post" name="pay_monthly" id="pay_monthly">
    ...
    <?php endif;?>
    <!-- <?php if($overtime_rate!='' || $overtime_rate!='' || $overtime_rate!='' || $overtime_rate!=''): ?>
    <?php $total_allow= $overtime_rate + $overtime_rate + $overtime_rate + $overtime_rate;?>
    <div class="row">
      <div class="col-md-12">
        <div class="form-group">
    ...
    <?php endif;?>
     <?php if($overtime_rate!='' || $overtime_rate!='' || $overtime_rate!=''): ?>
     <?php $total_de= $overtime_rate + $overtime_rate + $overtime_rate;?>
    <div class="row">
      <div class="col-md-12">
        <div class="form-group">
          <label for="name">Total Deductions</label>
          <input type="text" name="total_deductions" class="form-control" value="" readonly>
        </div>
      </div>
    </div>
    <?php else:?>
