...
<div class="row m-b-1">
  <div class="col-md-12">
    <div class="box box-block bg-white">
      <h2><span> <strong>Salary Info for <span class="text-danger" id="p_month"><?php echo date('F, Y');?></span></strong> </span></h2>
      <div class="table-responsive" data-pattern="priority-columns">
        <table class="table table-condensed table-hover table-bordered dataTable hover" id="xin_table">
          <thead>
            <tr>
              <th>Employee ID</th>
              <th>Name</th>
