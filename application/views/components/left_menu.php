...
$designation_info = $this->Graphene_model->read_designation_info($user_info[0]->designation_id);
...
<div class="site-sidebar">
  <div class="custom-scroll custom-scroll-light">
    <ul class="sidebar-menu">
      ...
      <li class="with-sub"> <a href="javascript:void(0);" class="waves-effect  waves-light"> <span class="s-caret"><i class="fa fa-angle-down"></i></span> <span class="s-icon"><i class="fas fa-building"></i></span> <span class="s-text"><?php echo $this->lang->line('left_organization');?></span> </a>
        <ul>
      ...
      <li class="with-sub"> <a href="javascript:void(0);" class="waves-effect  waves-light"> <span class="s-caret"><i class="fa fa-angle-down"></i></span> <span class="s-icon"><i class="fas fa-user-friends"></i></span> <span class="s-text"><?php echo $this->lang->line('dashboard_employees');?></span> </a>
        <ul>
          <?php  if(in_array('13',$role_resources_ids)) { ?>
          <li><a href="<?php echo site_url();?>employees"><?php echo $this->lang->line('dashboard_employeeslist');?></a></li>
          <?php } ?>
          ...
          <li> <a href="<?php echo site_url();?>employees/directory/" class="waves-effect waves-light"> <span class="s-icon"></span> <span class="s-text"><?php echo $this->lang->line('left_employees_directory');?></span> </a> </li>
          <?php } ?>
        </ul>
      </li>
      <?php } ?>
      ...
      <li class="with-sub"> <a href="javascript:void(0);" class="waves-effect  waves-light"> <span class="s-caret"><i class="fa fa-angle-down"></i></span> <span class="s-icon"><i class="fas fa-clock"></i></span> <span class="s-text"><?php echo $this->lang->line('left_timesheet');?></span> </a>
        <ul>
          ...
          <li><a href="<?php echo site_url();?>timesheet/date_attendance/"><?php echo $this->lang->line('left_date_wise_attendance');?></a></li>
          <?php } ?>
      ...
      <li class="menu-title">Payroll Menu</li>
        ...
        <?php if(in_array('42',$role_resources_ids)) { ?>
          <li>
            <a href="<?php echo site_url();?>payroll/reference/">
            <span class="s-icon"><i class="fas fa-book"></i></span>
            <span class="s-text"><?php echo $this->lang->line('left_reference');?></a></span>
          </li>
        <?php } ?>
        <?php if(in_array('42',$role_resources_ids)) { ?>
          <li>
            <a href="<?php echo site_url();?>payroll/dforms/">
            <span class="s-icon"><i class="fas fa-download"></i></span>
            <span class="s-text"><?php echo $this->lang->line('left_d_forms');?></a></span>
          </li>
        <?php } ?>
      ...
      <?php if(in_array('33',$role_resources_ids)) { ?>
        <li>
          <a href="<?php echo site_url('client');?>" class="waves-effect waves-light"> 
            ...
            <span class="s-text">Client Visits</span> 
          </a>
        </li>
      <?php } ?>
      <?php } ?>
      ...
      <?php  if(in_array('7',$role_resources_ids)) { ?>
        <li>
          <a href="<?php echo site_url('project');?>" class="waves-effect waves-light">
            <span class="s-icon"><i class="ti-layers-alt"></i></span>
            <span class="s-text"><?php echo $this->lang->line('left_projects');?></span> 
          </a>
        </li>
      <?php } ?>
      ...
      <?php if(in_array('33',$role_resources_ids)) { ?>
        <li>
          <a href="<?php echo site_url('timesheet/tasks');?>" class="waves-effect waves-light"> 
            <span class="s-icon"><i class="fa fa-tasks"></i></span> 
            <span class="s-text"><?php echo $this->lang->line('left_tasks');?></span> 
          </a>
        </li>
      <?php } ?>
      ...
      <?php } ?>
      <?php if($role_user[0]->role_id==1 || $role_user[0]->role_id==3 || $role_user[0]->role_id==10) {?>
      <li class="menu-title"><?php echo $this->lang->line('left_more');?></li>
      <?php } ?>
      <?php if(in_array('53',$role_resources_ids)){?>
      <li> <a href="<?php echo site_url();?>settings/" class="waves-effect waves-light"> <span class="s-icon"><i class="fas fa-cog"></i></span> <span class="s-text"><?php echo $this->lang->line('left_settings');?></span> </a> </li>
      <?php } ?>
      <?php if(in_array('54',$role_resources_ids)){?>
      <li> <a href="<?php echo site_url();?>settings/constants" class="waves-effect waves-light"> <span class="s-icon"><i class="fas fa-sliders-h"></i></span> <span class="s-text"><?php echo $this->lang->line('left_constants');?></span> </a> </li>
      <?php } ?>
     
      
      <?php if(in_array('56',$role_resources_ids)){?>
      <li> <a href="<?php echo site_url();?>settings/database_backup/" class="waves-effect waves-light"> <span class="s-icon"><i class="fas fa-database"></i></span> <span class="s-text"><?php echo $this->lang->line('left_db_backup');?></span> </a> </li>
      <?php } ?>
      <?php if(in_array('55',$role_resources_ids)){?>
      <li> <a href="<?php echo site_url();?>settings/email_template/" class="waves-effect waves-light"> <span class="s-icon"><i class="fas fa-mail-bulk"></i></span> <span class="s-text"><?php echo $this->lang->line('left_email_templates');?></span> </a> </li>
      <?php } ?>
      ...
      <li class="menu-title">Employee Menu</li>
        ...
        <?php if($role_user[0]->role_id==9) {?> 
          <li> <a href="<?php echo site_url('dashboard');?>" class="waves-effect waves-light"> <span class="s-icon"><i class="fas fa-home"></i></span> <span class="s-text">Home</span> </a> </li>
        <?php } ?>
        
      <li> <a href="<?php echo site_url();?>employee/attendance/" class="waves-effect waves-light"> <span class="s-icon"><i class="fa fa-clock-o"></i></span> <span class="s-text"><?php echo $this->lang->line('left_attendances');?></span> </a> </li>
      ...
      <li>
        <a href="<?php echo site_url();?>employee/client/" class="waves-effect waves-light"> 
          <span class="s-icon"><i class="fas fa-users"></i></span> 
          <span class="s-text">Client Visits</span> 
        </a>
      </li>
      ...
      <li> <a href="#" class="waves-effect waves-light" data-toggle="modal" data-target=".confirm-logout"> <span class="s-icon"><i class="fas fa-sign-out-alt"></i></span> <span class="s-text"><?php echo $this->lang->line('left_logout');?></span> </a> </li>
      <?php ?>
