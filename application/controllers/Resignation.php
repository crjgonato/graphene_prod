...
class Resignation extends MY_Controller {
    ...
    public function resignation_list()
     {
		...
		// get notice date
		$notice_date = $this->Graphene_model->set_date_format($r->notice_date);
		// get resignation date
		$resignation_date = $this->Graphene_model->set_date_format($r->resignation_date);
	...
	public function add_resignation() {
		...
		// Uncomment this if you need to an email notif
		// if ($result == TRUE) {
		...
		// 		//get email template
		// 		$template = $this->Graphene_model->read_email_template(12);
		// 		//get employee info
		...
		$Return['result'] = 'Resignation added.'; // Comment this if you uncomment above code.
		$this->output($Return);
		exit;
		}
	}
