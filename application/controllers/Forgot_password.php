...
class Forgot_password extends CI_Controller {
	...
	{
		$data['title'] = 'Graphene Reset Password';
		...
		if($this->input->post('iemail')) {
			...
			//get email template
			$template = $this->Graphene_model->read_email_template(2);
			//get employee info
			$query = $this->Graphene_model->read_user_info_byemail($this->input->post('iemail'));
