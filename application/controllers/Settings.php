...
class Settings extends MY_Controller {
	...
	public function output($Return=array()){
	 ...
	 public function index()
     {
		...
		$company_info = $this->Graphene_model->read_company_setting_info(1);
		$data = array(
	 ...
	 public function create_database_backup()
     {
		...
		if($this->input->post('type')==='backup') {
			...
			$result = $this->Graphene_model->add_backup($data);	
	 ...
	 public function delete_db_backup()
     {
		if($this->input->post('type')==='delete_old_backup') {
			...
			/*Delete backup*/
			$result = $this->Graphene_model->delete_all_backup_record();
			$baseurl = base_url();
	  ...
	  public function database_backup_list()
     {
		...
		$db_backup = $this->Graphene_model->all_db_backup();
	...
	// email templates > list
	  public function email_template_list()
     {
		...
		$email_template = $this->Graphene_model->get_email_templates();
	...
	public function read_tempalte()
	{
		...
		$result = $this->Graphene_model->read_email_template_info($id);
		$data = array(
	...
	public function password_read()
	{
		...
		$result = $this->Graphene_model->read_user_info($id);
		$data = array(
	...
	public function update_template() {
		...
		$result = $this->Graphene_model->update_email_template_record($data,$id);		
	...
	public function company_info() {
		...
		$result = $this->Graphene_model->update_company_info_record($data,$id);		
	...
	public function delete_single_backup() {
		...
		$Return = array('result'=>'', 'error'=>'');
		$id = $this->uri->segment(3);
		$result = $this->Graphene_model->delete_single_backup_record($id);
		if(isset($id)) {
	...
	// Contract Type > list
	  public function contract_type_list()
     {
		...
		$contract_type = $this->Graphene_model->get_contract_types();
	  ...
	  public function education_level_list()
     {
		...
		$constant = $this->Graphene_model->get_qualification_education();
	  ...
	  public function qualification_language_list()
     {
		...
		$constant = $this->Graphene_model->get_qualification_language();
	  ...
	  public function qualification_skill_list()
     {
		...
		$constant = $this->Graphene_model->get_qualification_skill();
	  ...
	  public function document_type_list()
     {
		...
		$constant = $this->Graphene_model->get_document_type();
	  ...
	  public function award_type_list()
     {
		...
		$constant = $this->Graphene_model->get_award_type();
	  ...
	  public function leave_type_list()
     {
		...
		$constant = $this->Graphene_model->get_leave_type();
	  ...
	  public function warning_type_list()
     {
		...
		$constant = $this->Graphene_model->get_warning_type();
	  ...
	  public function termination_type_list()
     {
		...
		$constant = $this->Graphene_model->get_termination_type();
	  ...
	  public function expense_type_list()
     {
		...
		$constant = $this->Graphene_model->get_expense_type();
	  ...
	  public function job_type_list()
     {
		...
		$constant = $this->Graphene_model->get_job_type();
	  ...
	  public function exit_type_list()
     {
		...
		$constant = $this->Graphene_model->get_exit_type();
	  ...
	  public function travel_arr_type_list()
     {
		...
		$constant = $this->Graphene_model->get_travel_type();
	  ...
	  public function payment_method_list()
     {
		...
		$constant = $this->Graphene_model->get_payment_method();
	  ...
	  public function currency_type_list()
     {
		...
		$constant = $this->Graphene_model->get_currency_types();
	...
	public function contract_type_info() {
		...
		$result = $this->Graphene_model->add_contract_type($data);
		if ($result == TRUE) {
	...
	public function document_type_info() {
		...
		$result = $this->Graphene_model->add_document_type($data);
		if ($result == TRUE) {
	...
	public function edu_level_info() {
		...
		$result = $this->Graphene_model->add_edu_level($data);
		if ($result == TRUE) {
	...
	public function edu_language_info() {
		...
		$result = $this->Graphene_model->add_edu_language($data);
		if ($result == TRUE) {
	...
	public function edu_skill_info() {
		...
		$result = $this->Graphene_model->add_edu_skill($data);
		if ($result == TRUE) {
	...
	public function payment_method_info() {
		...
		$result = $this->Graphene_model->add_payment_method($data);
		if ($result == TRUE) {
	...
	public function award_type_info() {
		...
		$result = $this->Graphene_model->add_award_type($data);
		if ($result == TRUE) {
	...
	public function leave_type_info() {
		...
		$result = $this->Graphene_model->add_leave_type($data);
		if ($result == TRUE) {
	...
	public function warning_type_info() {
		...
		$result = $this->Graphene_model->add_warning_type($data);
		if ($result == TRUE) {
	...
	public function termination_type_info() {
		...
		$result = $this->Graphene_model->add_termination_type($data);
		if ($result == TRUE) {
	...
	public function expense_type_info() {
		...
		$result = $this->Graphene_model->add_expense_type($data);
		if ($result == TRUE) {
	...
	public function job_type_info() {
		...
		$result = $this->Graphene_model->add_job_type($data);
		if ($result == TRUE) {
	...
	public function exit_type_info() {
		...
		$result = $this->Graphene_model->add_exit_type($data);
		if ($result == TRUE) {
	...
	public function travel_arr_type_info() {
		...
		$result = $this->Graphene_model->add_travel_arr_type($data);
		if ($result == TRUE) {
			$Return['result'] = 'Job Type added.';
		} else {
			$Return['error'] = 'Bug. Something went wrong, please try again.';
	...
	public function currency_type_info() {
		...
		$result = $this->Graphene_model->add_currency_type($data);
		if ($result == TRUE) {
	...
	public function delete_payment_method() {
		...
		if($this->input->post('type')=='delete_record') {
			...
			$Return = array('result'=>'', 'error'=>'');
			$id = $this->uri->segment(3);
			$result = $this->Graphene_model->delete_payment_method_record($id);
			if(isset($id)) {
	...
	public function delete_education_level() {
		...
		if($this->input->post('type')=='delete_record') {
			...
			$Return = array('result'=>'', 'error'=>'');
			$id = $this->uri->segment(3);
			$result = $this->Graphene_model->delete_education_level_record($id);
			if(isset($id)) {
	...
	public function delete_qualification_language() {
		...
		if($this->input->post('type')=='delete_record') {
			...
			$Return = array('result'=>'', 'error'=>'');
			$id = $this->uri->segment(3);
			$result = $this->Graphene_model->delete_qualification_language_record($id);
			if(isset($id)) {
	...
	public function delete_qualification_skill() {
		...
		if($this->input->post('type')=='delete_record') {
			...
			$Return = array('result'=>'', 'error'=>'');
			$id = $this->uri->segment(3);
			$result = $this->Graphene_model->delete_qualification_skill_record($id);
			if(isset($id)) {
	...
	public function delete_award_type() {
		...
		if($this->input->post('type')=='delete_record') {
			...
			$Return = array('result'=>'', 'error'=>'');
			$id = $this->uri->segment(3);
			$result = $this->Graphene_model->delete_award_type_record($id);
			if(isset($id)) {
	...
	public function delete_leave_type() {
		...
		if($this->input->post('type')=='delete_record') {
			...
			$Return = array('result'=>'', 'error'=>'');
			$id = $this->uri->segment(3);
			$result = $this->Graphene_model->delete_leave_type_record($id);
			if(isset($id)) {
	...
	public function delete_warning_type() {
		...
		if($this->input->post('type')=='delete_record') {
			...
			$Return = array('result'=>'', 'error'=>'');
			$id = $this->uri->segment(3);
			$result = $this->Graphene_model->delete_warning_type_record($id);
			if(isset($id)) {
	...
	public function delete_termination_type() {
		...
		if($this->input->post('type')=='delete_record') {
			...
			$Return = array('result'=>'', 'error'=>'');
			$id = $this->uri->segment(3);
			$result = $this->Graphene_model->delete_termination_type_record($id);
			if(isset($id)) {
	...
	public function delete_expense_type() {
		...
		if($this->input->post('type')=='delete_record') {
			...
			$Return = array('result'=>'', 'error'=>'');
			$id = $this->uri->segment(3);
			$result = $this->Graphene_model->delete_expense_type_record($id);
			if(isset($id)) {
	...
	public function delete_job_type() {
		...
		if($this->input->post('type')=='delete_record') {
			...
			$Return = array('result'=>'', 'error'=>'');
			$id = $this->uri->segment(3);
			$result = $this->Graphene_model->delete_job_type_record($id);
			if(isset($id)) {
	...
	public function delete_exit_type() {
		...
		if($this->input->post('type')=='delete_record') {
			...
			$Return = array('result'=>'', 'error'=>'');
			$id = $this->uri->segment(3);
			$result = $this->Graphene_model->delete_exit_type_record($id);
			if(isset($id)) {
	...
	public function delete_travel_arr_type() {
		...
		if($this->input->post('type')=='delete_record') {
			...
			$Return = array('result'=>'', 'error'=>'');
			$id = $this->uri->segment(3);
			$result = $this->Graphene_model->delete_travel_arr_type_record($id);
			if(isset($id)) {
	...
	public function update_document_type() {
		...
		$result = $this->Graphene_model->update_document_type_record($data,$id);		
	...
	public function update_contract_type() {
		...
		$result = $this->Graphene_model->update_contract_type_record($data,$id);		
	...
	public function update_education_level() {
		...
		$result = $this->Graphene_model->update_education_level_record($data,$id);		
	...
	public function update_qualification_language() {
		...
		$result = $this->Graphene_model->update_qualification_language_record($data,$id);		
	...
	public function update_award_type() {
		...
		$result = $this->Graphene_model->update_award_type_record($data,$id);		
	...
	public function update_leave_type() {
		...
		$result = $this->Graphene_model->update_leave_type_record($data,$id);		
	...
	public function update_warning_type() {
		...
		$result = $this->Graphene_model->update_warning_type_record($data,$id);		
	...
	public function update_termination_type() {
		...
		$result = $this->Graphene_model->update_termination_type_record($data,$id);		
	...
	public function update_expense_type() {
		...
		$result = $this->Graphene_model->update_expense_type_record($data,$id);		
	...
	public function update_job_type() {
		...
		$result = $this->Graphene_model->update_job_type_record($data,$id);		
	...
	public function update_exit_type() {
		...
		$result = $this->Graphene_model->update_exit_type_record($data,$id);		
	...
	public function update_travel_arr_type() {
		...
		$result = $this->Graphene_model->update_travel_arr_record($data,$id);		
	...
	public function update_currency_type() {
		...
		$result = $this->Graphene_model->update_currency_type_record($data,$id);		
