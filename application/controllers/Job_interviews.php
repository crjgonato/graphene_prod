    ...
    public function interview_list()
     {
		...
		// get date
		$interview_date = $this->Graphene_model->set_date_format($r->interview_date);		
		// get interviewees
		...
		foreach(explode(',',$r->interviewees_id) as $interviewees_id) {
			$user_intwee = $this->Graphene_model->read_user_info($interviewees_id);
		...
		foreach(explode(',',$r->interviewers_id) as $interviewers_id) {
			$user_intwer = $this->Graphene_model->read_user_info($interviewers_id);
		...
		// interview added by
		$u_added = $this->Graphene_model->read_user_info($r->added_by);
