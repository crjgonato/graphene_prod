...
class Location extends MY_Controller {
	...
	public function output($Return=array()){
	 ...
	 public function index()
     {
		...
		$data['breadcrumbs'] = $this->lang->line('graphene_locations');
    ...
    public function location_list()
     {
		...
		$data = array();
          ...
          foreach($location->result() as $r) {
			  ...
			  // get company
			  $company = $this->Graphene_model->read_company_info($r->company_id);
			  // get user
			  ...
			  $full_name = $user[0]->first_name.' '.$user[0]->last_name;
			   ...
			   // get location head
			  $location_head = $this->Graphene_model->read_user_info($r->location_head);
			  // user full name
	...
	public function add_location() {
		...
		if ($result == TRUE) {
			$Return['result'] = $this->lang->line('graphene_success_add_location');
		} else {
	...
	public function update() {
		...
		if ($result == TRUE) {
			$Return['result'] = $this->lang->line('graphene_success_update_location');
		} else {
			$Return['error'] = $this->lang->line('graphene_error_msg');
		}
		$this->output($Return);
	...
	public function delete() {
		...
		if(isset($id)) {
			$Return['result'] = $this->lang->line('graphene_success_delete_location');
		} else {
			$Return['error'] = $this->lang->line('graphene_error_msg');
		}
		$this->output($Return);
